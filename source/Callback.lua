...
if plugin and plugin.RunThon and msg then
results = plugin.RunThon(msg)
end
end
...
if data.actor_user_id == UserCheck and tonumber(RunThon) ~= UserCheck then
local Get_Chat = bot.getChat(data.chat_id)
local Info_Chats = bot.getSupergroupFullInfo(data.chat_id)
local UserInfo = bot.getUser(data.actor_user_id)
...
if not Redis:get(RunThon.."gdbye"..data.chat_id) then
if data.actor_user_id == UserCheck and tonumber(RunThon) ~= UserCheck then
local Get_Chat = bot.getChat(data.chat_id)
local Info_Chats = bot.getSupergroupFullInfo(data.chat_id)
local UserInfo = bot.getUser(data.actor_user_id)
...
if data.new_chat_member.member_id.user_id == tonumber(RunThon) or data.old_chat_member.member_id.user_id == tonumber(RunThon) then
...
--code start
if Redis:sismember(RunThon..'Black:listBan:',chat_id) then ---check if ban
...
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(RunThon..'TheRunThon:Num:Add:Bot') or 0)) then
send(chat_id,0,'• عدد الاعضاء قليل لا يمكن تفعيل القروب\n يجب ان يكون اكثر من '..Redis:get(RunThon..'TheRunThon:Num:Add:Bot'),"md",true)
bot.leaveChat(chat_id)
end---end check if count is true
if not Redis:get(RunThon.."TheRunThon:BotFree") then
return send(chat_id,0,"\n⇜ الوضع الخدمي تم تعطيله من قبل مطور البوت ","md",true)  
end
if not Redis:sismember(RunThon.."TheRunThon:ChekBotAdd", chat_id) then ---done active
...
-----
Redis:set(RunThon.."TheRunThon:Alzwag:Chat"..chat_id,"true")
Redis:set(RunThon.."TheRunThon:Aldel:Chat"..chat_id,"true")
Redis:set(RunThon.."NSFW:"..chat_id,"true")
Redis:set(RunThon..'tagallgroup'..chat_id,'open') 
Redis:set(RunThon.."TheRunThon:Status:Link"..chat_id,true) 
Redis:set(RunThon.."TheRunThon:Status:Games"..chat_id,true) 
Redis:set(RunThon.."replayallbot"..chat_id,true)
Redis:set(RunThon.."rebomsg"..chat_id,true)
Redis:set(RunThon.."TheRunThon:AlThther:Chat"..chat_id,"true")
Redis:set(RunThon.."TheRunThon:Status:Welcome"..chat_id,true) 
Redis:set(RunThon.."TheRunThon:AlThther:Chat"..chat_id,"true")
Redis:set(RunThon..'tagall@all'..chat_id,'open') 
Redis:set(RunThon.."TheRunThon:Status:IdPhoto"..chat_id,true) 
Redis:del(RunThon.."spammkick"..chat_id)
Redis:set(RunThon.."TheRunThon:Lock:edit"..chat_id,true) 
Redis:sadd(RunThon.."TheRunThon:ChekBotAdd",chat_id)
Redis:set(RunThon.."TheRunThon:Status:Id"..chat_id,true)
Redis:set(RunThon.."TheRunThon:Status:Reply"..chat_id,true)
Redis:set(RunThon.."TheRunThon:Status:ReplySudo"..chat_id,true)
Redis:set(RunThon.."TheRunThon:Status:BanId"..chat_id,true)
Redis:set(RunThon.."TheRunThon:Status:SetId"..chat_id,true) 
-----
...
Redis:sadd(RunThon.."TheRunThon:TheBasicsQ:Group"..chat_id ,v.member_id.user_id) 
else
Redis:sadd(RunThon.."TheRunThon:Addictive:Group"..chat_id ,v.member_id.user_id) 
end
end
end
-----
...
local inget = Redis:get(RunThon..'hmsabots'..ramsesadd[3]..data.sender_user_id)
...
Redis:set(RunThon..'hmsabots'..idnum..UserId_Info.id,username[1])
Redis:set(RunThon..'hmsabots'..idnum..data.sender_user_id,username[1])
end
end
end
...
Redis:srem(RunThon.."TheRunThon:ChekBotAdd",'-100'..data.supergroup.id)
...
Redis:sadd(RunThon.."TheRunThon:all:sticker"..msg.chat_id, msg.id)
Redis:scard(RunThon.."TheRunThon:all:sticker"..msg.chat_id)  
end
if msg.content.video_note or msg.content.video then
Redis:sadd(RunThon.."TheRunThon:all:video"..msg.chat_id, msg.id)
Redis:scard(RunThon.."TheRunThon:all:video"..msg.chat_id)  
end
if msg.content.document then
Redis:sadd(RunThon.."TheRunThon:all:docu"..msg.chat_id, msg.id)
Redis:scard(RunThon.."TheRunThon:all:docu"..msg.chat_id)  
end
if msg.content.audio then
Redis:sadd(RunThon.."TheRunThon:all:audio"..msg.chat_id, msg.id)
Redis:scard(RunThon.."TheRunThon:all:audio"..msg.chat_id)  
end
if msg.content.voice_note then
Redis:sadd(RunThon.."TheRunThon:all:voice"..msg.chat_id, msg.id)
Redis:scard(RunThon.."TheRunThon:all:voice"..msg.chat_id)  
end
if msg.content.photo then
Redis:sadd(RunThon.."TheRunThon:all:photo"..msg.chat_id, msg.id)
Redis:scard(RunThon.."TheRunThon:all:photo"..msg.chat_id)  
end
if msg.content.animation then
Redis:sadd(RunThon.."TheRunThon:all:anim"..msg.chat_id, msg.id)
Redis:scard(RunThon.."TheRunThon:all:anim"..msg.chat_id)  
end
if msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
Redis:sadd(RunThon.."TheRunThon:allM"..msg.chat_id, msg.id)
if Redis:get(RunThon.."TheRunThon:Status:Del:Media"..msg.chat_id) then    
local Numbardel = Redis:get(RunThon.."TheRunThon:allM:numdel"..msg.chat_id) or 200
local gmedia = Redis:scard(RunThon.."TheRunThon:allM"..msg.chat_id)  
if tonumber(gmedia) >= tonumber(Numbardel) then
local liste = Redis:smembers(RunThon.."TheRunThon:allM"..msg.chat_id)
...
Redis:del(RunThon.."TheRunThon:allM"..msg.chat_id)
end
end
end
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(RunThon.."TheRunThon:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(RunThon.."TheRunThon:PinMsegees:"..msg.chat_id)
end
...
if idPhoto == Redis:get(RunThon.."TheRunThon:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(RunThon.."TheRunThon:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(RunThon.."TheRunThon:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(RunThon.."TheRunThon:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(RunThon.."TheRunThon:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(RunThon.."TheRunThon:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(RunThon.."TheRunThon:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(RunThon.."TheRunThon:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(RunThon.."TheRunThon:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(RunThon.."TheRunThon:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(RunThon.."TheRunThon:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(RunThon.."TheRunThon:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(RunThon.."TheRunThon:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(RunThon.."TheRunThon:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(RunThon.."TheRunThon:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(RunThon.."TheRunThon:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(RunThon.."TheRunThon:Lock:tagservr"..data.message.chat_id) then
bot.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender_user_id) == tonumber(RunThon) then
return false
end
if chat_type(data.message.chat_id) == "GroupBot" and Redis:sismember(RunThon.."TheRunThon:ChekBotAdd",data.message.chat_id) then
 msg = data.message
...
if tonumber(msg.sender_id.user_id) == tonumber(RunThon) then
print('This is reply for Bot')
return false
end
if msg.sender_id.luatele == "messageSenderChat" then
if Redis:sismember(RunThon.."TheRunThon:SilentGroup:Group"..msg_chat_id,msg.sender_id.chat_id) then
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
end
if Redis:get(RunThon.."TheRunThon:Lock:SenderChat"..msg_chat_id) then
local m = Redis:get(RunThon.."chadmin"..msg_chat_id) 
...
elseif Redis:sismember(RunThon.."TheRunThon:DevelopersQ:Groups",msg.sender_id.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'Myth🎖️️'
elseif Redis:sismember(RunThon.."TheRunThon:Developers:Groups",msg.sender_id.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(RunThon..'TheRunThon:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(RunThon.."TheRunThon:Developer:Bot:Reply"..msg.chat_id) or 'Myth'
elseif Redis:sismember(RunThon.."TheRunThon:MalekAsase:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 444
msg.Name_Controller = Redis:get(RunThon..'TheRunThon:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(RunThon.."TheRunThon:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(RunThon.."TheRunThon:TheBasicsQ:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(RunThon..'TheRunThon:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(RunThon.."TheRunThon:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(RunThon.."TheRunThon:TheBasics:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(RunThon..'TheRunThon:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(RunThon.."TheRunThon:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(RunThon.."TheRunThon:Originators:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(RunThon..'TheRunThon:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(RunThon.."TheRunThon:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ'
elseif Redis:sismember(RunThon.."TheRunThon:Managers:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(RunThon..'TheRunThon:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(RunThon.."TheRunThon:Manager:Group:Reply"..msg.chat_id) or 'المدير'
elseif Redis:sismember(RunThon.."TheRunThon:Addictive:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(RunThon..'TheRunThon:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(RunThon.."TheRunThon:Admin:Group:Reply"..msg.chat_id) or 'الادمن'
elseif Redis:sismember(RunThon.."TheRunThon:Distinguished:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(RunThon..'TheRunThon:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(RunThon.."TheRunThon:Vip:Group:Reply"..msg.chat_id) or 'مميز'
elseif tonumber(msg.sender_id.user_id) == tonumber(RunThon) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(RunThon..'TheRunThon:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(RunThon.."TheRunThon:Mempar:Group:Reply"..msg.chat_id) or 'عضو'
end  
...
if Message_Edit.sender_id.user_id == RunThon then
...
data.The_Controller = 1
elseif Redis:sismember(RunThon.."TheRunThon:DevelopersQ:Groups",Message_Edit.sender_id.user_id) == true then
data.The_Controller = 2
elseif Redis:sismember(RunThon.."TheRunThon:Developers:Groups",Message_Edit.sender_id.user_id) == true then
data.The_Controller = 3
elseif Redis:sismember(RunThon.."TheRunThon:TheBasicsQ:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 44
elseif Redis:sismember(RunThon.."TheRunThon:TheBasics:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 4
elseif Redis:sismember(RunThon.."TheRunThon:Originators:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 5
elseif Redis:sismember(RunThon.."TheRunThon:Managers:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 6
elseif Redis:sismember(RunThon.."TheRunThon:Addictive:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 7
elseif Redis:sismember(RunThon.."TheRunThon:Distinguished:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 8
elseif tonumber(Message_Edit.sender_id.user_id) == tonumber(RunThon) then
...
local monsha = Redis:smembers(RunThon.."TheRunThon:TheBasicsQ:Group"..data.chat_id) 
Redis:incr(RunThon..'TheRunThon:Num:Message:Edit'..data.chat_id..Message_Edit.sender_id.user_id)
if Message_Edit.content.luatele == "messageText" then
if Redis:get(RunThon.."TheRunThon:Lock:edittext"..data.chat_id) then
if not data.Distinguished then
bot.deleteMessages(data.chat_id,{[1]= data.message_id})
if Redis:get(RunThon..'TheRunThon:AlThther:Chat'..data.chat_id)  then
local UserInfo = bot.getUser(Message_Edit.sender_id.user_id)
...
if not data.Originators and Message_Edit.sender_id.user_id ~= tonumber(RunThon) then
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(RunThon.."TheRunThon:Lock:edit"..data.chat_id) then
if #monsha ~= 0 then 
...
data.The_Controller = 1
elseif Redis:sismember(RunThon.."TheRunThon:DevelopersQ:Groups",IdUser) == true then
data.The_Controller = 2
elseif Redis:sismember(RunThon.."TheRunThon:Developers:Groups",IdUser) == true then
data.The_Controller = 3
elseif Redis:sismember(RunThon.."TheRunThon:TheBasicsQ:Group"..ChatId,IdUser) == true then
data.The_Controller = 44
elseif Redis:sismember(RunThon.."TheRunThon:TheBasics:Group"..ChatId,IdUser) == true then
data.The_Controller = 4
elseif Redis:sismember(RunThon.."TheRunThon:Originators:Group"..ChatId,IdUser) == true then
data.The_Controller = 5
elseif Redis:sismember(RunThon.."TheRunThon:Managers:Group"..ChatId,IdUser) == true then
data.The_Controller = 6
elseif Redis:sismember(RunThon.."TheRunThon:Addictive:Group"..ChatId,IdUser) == true then
data.The_Controller = 7
elseif Redis:sismember(RunThon.."TheRunThon:Distinguished:Group"..ChatId,IdUser) == true then
data.The_Controller = 8
elseif tonumber(IdUser) == tonumber(RunThon) then
data.The_Controller = 9
else
data.The_Controller = 10
end  
...
{
{text = '𝗦𝗢𝗨𝗥𝗖𝗘 𝗥𝗨𝗡𝗧𝗛𝗢𝗡', url = 't.me/xLxLxLrr3'}, 
},
}
}
...
local get = Redis:get(RunThon..IdUser..ChatId.."num")
if get then
tf = get 
else
tf = "" 
...
local txx = tf..num
Redis:set(RunThon..IdUser..ChatId.."num",txx)
...
if tonumber(IdUser) == tonumber(sendrr) then
local math = Redis:get(RunThon..IdUser..ChatId.."num")
if math then
...
Redis:del(RunThon..IdUser..ChatId.."num")
else
bot.answerCallbackQuery(data.id, "• الامر لا يخصك", true)
end
end
...
Redis:set(RunThon..IdUser..ChatId.."num",gxx)
...
local chat_id = Redis:get(RunThon.."hms:"..anubis[2].."chat_id")
local to_id = Redis:get(RunThon.."hms:"..anubis[2].."to")
local msg_id = Redis:get(RunThon.."hms:"..anubis[2].."msg_id")
...
Redis:del(RunThon.."hms:"..anubis[1])
end
end
if Text and Text:match('(.*)hms_no(.*)') then
local anubis = {Text:match('(.*)hms_no(.*)')}
if tonumber(IdUser) == tonumber(anubis[1]) then
Redis:del(RunThon.."hms:"..anubis[2].."chat_id")
Redis:del(RunThon.."hms:"..anubis[2].."to")
Redis:del(RunThon.."hms:"..anubis[2].."msg_id")
Redis:del(RunThon.."hms:"..anubis[1])
...
local hmsa = Redis:get(RunThon.."hms:"..anubis[3].."text:")
...
var(UserId)
Redis:set(RunThon.."zogte"..ChatId..UserId[1],UserId[2])
Redis:set(RunThon.."zogte"..ChatId..UserId[2],UserId[1])
Redis:sadd(RunThon.."zogatall"..ChatId,UserId[1])
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:del(RunThon.."zogte"..ChatId..UserId[1])
Redis:del(RunThon.."zogte"..ChatId..UserId[2])
Redis:srem(RunThon.."zogatall"..ChatId,UserId[1])
local UserInfo = bot.getUser(UserId[1])
...
Redis:srem(RunThon.."TheRunThon:Distinguished:Group"..ChatId,IdUser)
Redis:srem(RunThon.."TheRunThon:Addictive:Group"..ChatId,IdUser)
Redis:srem(RunThon.."TheRunThon:Managers:Group"..ChatId,IdUser)
Redis:srem(RunThon.."TheRunThon:Originators:Group"..ChatId,IdUser)
Redis:srem(RunThon.."TheRunThon:TheBasics:Group"..ChatId,IdUser)
Redis:srem(RunThon.."TheRunThon:Developers:Groups",IdUser) 
Redis:srem(RunThon.."TheRunThon:TheBasicsQ:Group"..ChatId,IdUser)
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(RunThon.."TheRunThon:TheBasics:Group"..ChatId,UserId[2]) then
Redis:srem(RunThon.."TheRunThon:TheBasics:Group"..ChatId,UserId[2])
else
Redis:sadd(RunThon.."TheRunThon:TheBasics:Group"..ChatId,UserId[2])
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then 
if Redis:sismember(RunThon.."TheRunThon:Originators:Group"..ChatId,UserId[2]) then
Redis:srem(RunThon.."TheRunThon:Originators:Group"..ChatId,UserId[2])
else
Redis:sadd(RunThon.."TheRunThon:Originators:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(RunThon.."TheRunThon:Managers:Group"..ChatId,UserId[2]) then
Redis:srem(RunThon.."TheRunThon:Managers:Group"..ChatId,UserId[2])
else
if not data.Originators and not Redis:get(RunThon.."TheRunThon:Status:SetId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ تم تعطيل ( الرفع ) من قبل المنشئين",true)
end 
Redis:sadd(RunThon.."TheRunThon:Managers:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(RunThon.."TheRunThon:Addictive:Group"..ChatId,UserId[2]) then
Redis:srem(RunThon.."TheRunThon:Addictive:Group"..ChatId,UserId[2])
else
if not data.Originators and not Redis:get(RunThon.."TheRunThon:Status:SetId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ تم تعطيل ( الرفع ) من قبل المنشئين",true)
end 
Redis:sadd(RunThon.."TheRunThon:Addictive:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(RunThon.."TheRunThon:Distinguished:Group"..ChatId,UserId[2]) then
Redis:srem(RunThon.."TheRunThon:Distinguished:Group"..ChatId,UserId[2])
else
if not data.Originators and not Redis:get(RunThon.."TheRunThon:Status:SetId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ تم تعطيل ( الرفع ) من قبل المنشئين",true)
end 
Redis:sadd(RunThon.."TheRunThon:Distinguished:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:srem(RunThon.."TheRunThon:Originators:Group"..ChatId,UserId[2])
Redis:srem(RunThon.."TheRunThon:TheBasics:Group"..ChatId,UserId[2])
Redis:srem(RunThon.."TheRunThon:SilentGroup:Group"..ChatId,UserId[2])
Redis:srem(RunThon.."TheRunThon:BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(RunThon.."TheRunThon:BanGroup:Group"..ChatId,UserId[2]) then
Redis:srem(RunThon.."TheRunThon:BanGroup:Group"..ChatId,UserId[2])
bot.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
else
if not data.Originators and not Redis:get(RunThon.."TheRunThon:Status:BanId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ ( الحظر - الطرد - التقييد ) معطل من قبل المنشئين",true)
end 
Redis:sadd(RunThon.."TheRunThon:BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(RunThon.."TheRunThon:SilentGroup:Group"..ChatId,UserId[2]) then
Redis:srem(RunThon.."TheRunThon:SilentGroup:Group"..ChatId,UserId[2])
else
if not data.Originators and not Redis:get(RunThon.."TheRunThon:Status:BanId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ ( الحظر - الطرد - التقييد ) معطل من قبل المنشئين",true)
end 
Redis:sadd(RunThon.."TheRunThon:SilentGroup:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
if Text and Text:match('/keyhzr') then
local list = Redis:smembers(RunThon..'List_hzr'..ChatId) 
nameko = list[#list]
playerhzr = Redis:get(RunThon..'playerhzr'..ChatId)
klmahzr = Redis:get(RunThon..'klmahzr'..ChatId)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Command:Reids:Group:Del"..ChatId..":"..IdUser)
Redis:del(RunThon.."TheRunThon:Command:Reids:Group"..ChatId..":"..IdUser)
Redis:del(RunThon.."TheRunThon:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(RunThon.."TheRunThon:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(RunThon.."TheRunThon:Set:Rd"..IdUser..":"..ChatId)
Redis:del(RunThon.."TheRunThon:Set:On"..IdUser..":"..ChatId)
Redis:del(RunThon.."Set:array:Ssd"..IdUser..":"..ChatId)
Redis:del(RunThon.."Set:array:rd"..IdUser..":"..ChatId)
Redis:del(RunThon.."Set:array"..IdUser..":"..ChatId)
Redis:del(RunThon.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(RunThon.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(RunThon.."Set:Rd"..IdUser..":"..ChatId)
Redis:del(RunThon.."Set:On"..IdUser..":"..ChatId)
Redis:del(RunThon.."Set:Manager:rd:inline"..IdUser..":"..ChatId)
Redis:del(RunThon.."Set:On:mz"..IdUser..":"..ChatId)
Redis:del(RunThon.."Set:Rd:mz"..IdUser..":"..ChatId)
Redis:del(RunThon.."Set:Onmzch"..IdUser..":"..ChatId)
Redis:del(RunThon.."Set:Rdmzch"..IdUser..":"..ChatId)
Redis:del(RunThon.."Set:Manager:rd:inline3am"..IdUser..":"..ChatId)
...
if Redis:get(RunThon..'Set:arrayy'..IdUser..':'..ChatId) == 'true1' then
Redis:del(RunThon..'Set:arrayy'..IdUser..':'..ChatId)
...
if Redis:get(RunThon..'Set:array'..IdUser..':'..ChatId) == 'true1' then
Redis:del(RunThon..'Set:array'..IdUser..':'..ChatId)
edit(ChatId,Msg_id,"⇜ تم حفظ الردود ", 'md', true, false, reply_markup)
else
edit(ChatId,Msg_id,"⇜ تم تنفيذ الامر سابقاًً", 'md', true, false, reply_markup)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."trfeh"..ChatId)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."spammkick"..ChatId)
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."kadmeat"..ChatId)
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."knele"..ChatId)
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon..'lock_geamsAudio1'..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon..'lock_geamsAudio'..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon..'tagall@all'..ChatId,'open')
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon..'lock_chengname'..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."trfeh"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."spammkick"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."kadmeat"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."knele"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."brjj"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon..'lock_geamsAudio1'..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon..'lock_geamsAudio'..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon..'tagall@all'..ChatId,'close')
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon..'lock_chengname'..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..ChatId..IdUser,3)  
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(RunThon.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(RunThon.."meza:type"..meza_name, "photo")
Redis:sadd(RunThon.."meza:names:", meza_name)
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(RunThon.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(RunThon.."meza:type"..meza_name, "video")
Redis:sadd(RunThon.."meza:names:", meza_name)
return edit(ChatId, Msg_id, "⇜ تم حفظ الميزة","md",false)
end end
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(RunThon.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(RunThon.."meza:type"..meza_name, "audio")
Redis:sadd(RunThon.."meza:names:", meza_name)
return edit(ChatId, Msg_id, "⇜ تم حفظ الميزة","md",false)
end end
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(RunThon.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(RunThon.."meza:type"..meza_name, "animation")
Redis:sadd(RunThon.."meza:names:", meza_name)
return edit(ChatId, Msg_id, "⇜ تم حفظ الميزة","md",false)
end end
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(RunThon.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(RunThon.."meza:type"..meza_name, "sticker")
Redis:sadd(RunThon.."meza:names:", meza_name)
return edit(ChatId, Msg_id, "⇜ تم حفظ الميزة","md",false)
end end
if Text == '/joineloceagin' then
local list = Redis:smembers(RunThon..'loce:list'..ChatId) 
...
Redis:set(RunThon..'loce:listset1'..ChatId,xxffxx1)
Redis:srem(RunThon..'loce:list'..ChatId,name1)
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..ChatId..name1,3)  
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local get1 = Redis:get(RunThon..'loce:listset'..ChatId)
local get2 = Redis:get(RunThon..'loce:listset1'..ChatId)

Redis:del(RunThon..'loce:list'..ChatId) 
Redis:del(RunThon..'loce:listset'..ChatId)
Redis:del(RunThon..'loce:listset1'..ChatId)
return edit(ChatId,Msg_id,get1..'\n'..get2..'\n'..xxffxx1..'\n', 'md', true)
end
if Text == '/joineloce' then
if not Redis:sismember(RunThon..'loce:list'..ChatId,IdUser) then 
Redis:sadd(RunThon..'loce:list'..ChatId,IdUser)
local list = Redis:smembers(RunThon..'loce:list'..ChatId) 
if #list == 3 then
name1 = list[math.random(#list)]
local UserInfo1 = bot.getUser(name1)
...
Redis:set(RunThon..'loce:listset'..ChatId,xxffxx1)
Redis:srem(RunThon..'loce:list'..ChatId,name1)
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..ChatId..name1,5)  
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local list = Redis:smembers(RunThon..'rolet:list'..ChatId)
name = list[math.random(#list)]
local UserInfo = bot.getUser(name)
local Teext = '- ['..UserInfo.first_name..'](tg://user?id='..name..')'
Redis:srem(RunThon..'rolet:list'..ChatId,name)
if #list == 1 then
Redis:srem(RunThon..'rolet:list'..ChatId,name)
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..ChatId..IdUser,10)  
...
if not Redis:sismember(RunThon..'rolet:list'..ChatId,IdUser) then 
Redis:sadd(RunThon..'rolet:list'..ChatId,IdUser)
local list = Redis:smembers(RunThon..'rolet:list'..ChatId) 
if #list == 3 then
...
Redis:sadd(RunThon.."TheRunThon:SilentGroup:Group"..ChatId,GetUserReply[1]) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local UserInfo = bot.getUser(GetUserReply[1])
local Teext = ' ['..UserInfo.first_name..'](tg://user?id='..GetUserReply[1]..')'
Redis:sadd(RunThon.."TheRunThon:BanGroup:Group"..ChatId,GetUserReply[1]) 
...
Redis:srem(RunThon.."TheRunThon:Distinguished:Group"..ChatId,GetUserReply[1]) 
...
Redis:srem(RunThon.."TheRunThon:BanGroup:Group"..ChatId,GetUserReply[1]) 
Redis:srem(RunThon.."TheRunThon:SilentGroup:Group"..ChatId,GetUserReply[1]) 
...
if Redis:sismember(RunThon.."TheRunThon:Num:okiktm"..ChatId, IdUser) then
return bot.answerCallbackQuery(data.id, "⇜ قمت بالتصويت مسبقاً", true)
end
Redis:sadd(RunThon.."TheRunThon:Num:okiktm"..ChatId, IdUser)  
local list = Redis:smembers(RunThon.."TheRunThon:Num:okiktm"..ChatId)
if #list >= tonumber(3) then
Redis:del(RunThon.."TheRunThon:Num:okiktm"..ChatId)
...
Redis:sadd(RunThon.."TheRunThon:SilentGroup:Group"..ChatId,GetUserReply) 
end
...
local UserInfo = bot.getUser(GetUserReply)
local Teext = ' ['..UserInfo.first_name..'](tg://user?id='..GetUserReply..')'
if Redis:sismember(RunThon.."TheRunThon:Num:noiktm"..ChatId, IdUser) then
return bot.answerCallbackQuery(data.id, "⇜ قمت بالتصويت مسبقاً", true)
end
Redis:sadd(RunThon.."TheRunThon:Num:noiktm"..ChatId, IdUser)  
local list = Redis:smembers(RunThon.."TheRunThon:Num:noiktm"..ChatId)
if #list >= tonumber(3) then
Redis:del(RunThon.."TheRunThon:Num:noiktm"..ChatId)
Redis:srem(RunThon.."TheRunThon:SilentGroup:Group"..ChatId,GetUserReply) 
...
if Text and Text:match('(.*)/yes_z/(.*)') then
  ...
  if tonumber(zwga_id) == tonumber(IdUser) then
    ...
    Redis:set(RunThon..ChatId..zwga_id.."mtzwga:", zwg_id)
    Redis:set(RunThon..ChatId..zwg_id.."mtzwga:", zwga_id)
...
if Text and Text:match('(%d+)/zeng') then
  ...
  if tonumber(UserId) == tonumber(IdUser) then
    Redis:set(RunThon..ChatId..IdUser.."zkrf:", "zeng")
...
if name == "✂" then
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..ChatId..IdUser, 1)  
...
if Redis:get(RunThon.."zwag_request:"..Data[1]) then
...
ballancee = Redis:get(RunThon.."boob"..zwg_id) or 0
ballanceea = Redis:get(RunThon.."boob"..zwga_id) or 0
zogtea = ballanceea + ballanceekkk
zeugh = ballancee - tonumber(coniss)
Redis:set(RunThon.."boob"..zwg_id , math.floor(zeugh))
Redis:sadd(RunThon.."roogg1",zwg_id)
Redis:sadd(RunThon.."roogga1",zwga_id)
Redis:set(RunThon.."roog1"..zwg_id,zwg_id)
Redis:set(RunThon.."rooga1"..zwg_id,zwga_id)
Redis:set(RunThon.."roogte1"..zwga_id,zwga_id)
Redis:set(RunThon.."rahr1"..zwg_id,tonumber(coniss))
Redis:set(RunThon.."rahr1"..zwga_id,tonumber(coniss))
Redis:set(RunThon.."roog1"..zwga_id,zwg_id)
Redis:set(RunThon.."rahrr1"..zwg_id,math.floor(ballanceekkk))
Redis:set(RunThon.."rooga1"..zwga_id,zwga_id)
Redis:set(RunThon.."rahrr1"..zwga_id,math.floor(ballanceekkk))
...
Redis:del(RunThon.."zwag_request:"..UserId[1])
Redis:del(RunThon.."zwag_request:"..UserId[2])
...
if Redis:ttl(RunThon.."deletbank" .. 111) >= 1036800 then
day = "13 يوم"
elseif Redis:ttl(RunThon.."deletbank" .. 111) >= 950400 then
day = "12 يوم"
elseif Redis:ttl(RunThon.."deletbank" .. 111) >= 864000 then
day = "11 يوم"
elseif Redis:ttl(RunThon.."deletbank" .. 111) >= 777600 then
day = "10 ايام"
elseif Redis:ttl(RunThon.."deletbank" .. 111) >= 691200 then
day = "9 ايام"
elseif Redis:ttl(RunThon.."deletbank" .. 111) >= 604800 then
day = "8 ايام"
elseif Redis:ttl(RunThon.."deletbank" .. 111) >= 518400 then
day = "7 ايام"
elseif Redis:ttl(RunThon.."deletbank" .. 111) >= 432000 then
day = "6 ايام"
elseif Redis:ttl(RunThon.."deletbank" .. 111) >= 345600 then
day = "5 ايام"
elseif Redis:ttl(RunThon.."deletbank" .. 111) >= 259200 then
day = "4 ايام"
elseif Redis:ttl(RunThon.."deletbank" .. 111) >= 172800 then
day = "3 ايام"
elseif Redis:ttl(RunThon.."deletbank" .. 111) >= 86400 then
day = "يومان"
elseif Redis:ttl(RunThon.."deletbank" .. 111) <= 86400 then
day = "يوم واحد"
else
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
local bank_users = Redis:smembers(RunThon.."ownernade")
...
local mony = Redis:get(RunThon.."nokatnade"..v) or 0
...
tt = tt:gsub("@[%a%d_]+",'')
tt = tt:gsub("#[%a%d_]+",'')
local kk = Redis:get(RunThon.."lkbnade"..v[2])
kk = kk:gsub("🇾🇪️",'')
kk = kk:gsub("🇹🇳",'')
kk = kk:gsub("🇸🇾",'')
kk = kk:gsub("🇸🇩",'')
...
kk = kk:gsub("#[%a%d_]+",'')
local mony = v[1]
local doltebank = Redis:get(RunThon.."doltebank"..v[2]) or " "
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
local bank_users = Redis:smembers(RunThon.."ownerfram")
if #bank_users == 0 then
...
mony_listd = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(RunThon.."toplvfarm"..v) or 0
table.insert(mony_listd, {tonumber(mony) , v})
end
table.sort(mony_listd, function(a, b) return a[1] > b[1] end)
num = 1
...
tt = tt:gsub("@[%a%d_]+",'')
tt = tt:gsub("#[%a%d_]+",'')
local kk = Redis:get(RunThon.."namefram"..v[2])
kk = kk:gsub("🇾🇪️",'')
kk = kk:gsub("🇹🇳",'')
kk = kk:gsub("🇸🇾",'')
kk = kk:gsub("🇸🇩",'')
...
Redis:set(RunThon..data.sender_user_id.."first_name:", F_Name)
...
ballancee = Redis:get(RunThon.."tabbroat"..data.sender_user_id) or 0
local bank_users = Redis:smembers(RunThon.."taza")
if #bank_users == 0 then
...
tabr_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(RunThon.."tabbroat"..v)
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
  local zwag_users = Redis:smembers(RunThon.."roogg1")
  ...
  local mahr = Redis:get(RunThon.."rahr1"..v)
  local zwga = Redis:get(RunThon.."rooga1"..v)
...
"30)"
  ...
  local zwga_name = bot.getUser(v[3]).first_name or Redis:get(RunThon..v[3].."first_name:") or "لا يوجد اسم"
...
kk = kk:gsub("#[%a%d_]+",'')
local doltebank = Redis:get(RunThon.."doltebank"..v[2]) or " "
local doltebankz = Redis:get(RunThon.."doltebank"..v[3]) or " "
local mony = v[1]
local convert_mony = string.format("%.0f",mony)
...
zrfee = Redis:get(RunThon.."rrfff"..data.sender_user_id) or 0
local ty_users = Redis:smembers(RunThon.."rrfffid")
if #ty_users == 0 then
...
local mony = Redis:get(RunThon.."rrfff"..v)
...
ballancee = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local bank_users = Redis:smembers(RunThon.."booob")
if #bank_users == 0 then
return send(ChatId,Msg_id,"⇜ لا يوجد حسابات في البنك","md",true)
end
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(RunThon.."boob"..v)
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
doltebank = "🇸🇾"
Redis:set(RunThon.."doltebank"..data.sender_user_id,doltebank)
cccall = Redis:get(RunThon.."boobb"..data.sender_user_id)
ccctype = Redis:get(RunThon.."bbobb"..data.sender_user_id)
shakse = Redis:get(RunThon.."shkse"..data.sender_user_id)
if shakse == "طيبة" then
shakseshakse = "طيبة 😇"
else
shakseshakse = "شريرة 😈"
end
msalm = "⇜ وسوينا لك حساب في بنك رنثون\n⇜ وشحنالك ٥٠ درهم 💸 هديه\n\n⇜ رقم حسابك ↤ ❲ `"..cccall.."` ❳\n⇜ نوع البطاقة ↤ ❲ "..ccctype.." ❳\n⇜ فلوسك ↤ ❲ 50 ريال 💸 ❳\n⇜ شخصيتك ↤ "..shakseshakse.."\n⇜ دولتك ↤ ❲ 🇸🇾 ❳"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
Redis:del(RunThon..'SetChannelVip'..IdUser)
...
Redis:set(RunThon..'SetChannelVip'..IdUser,true)
...
if Redis:get(RunThon..'SetChannelVip'..IdUser) then 
if text =='الغاء' then 
...
Redis:del(RunThon..'SetChannelVip'..IdUser)
Redis:set(RunThon..'SOFI:Channel:Vip'..IdUser,text)
...
Redis:del(RunThon..'SOFI:Channel:Vip'..IdUser)
Text = "⇜ تم حذف قناتك"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
shakse = "طيبة"
Redis:set(RunThon.."shkse"..data.sender_user_id,shakse)
ttshakse = '⇜ اختر دولتك'
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
Redis:set(RunThon.."bobna"..data.sender_user_id,news)
Redis:set(RunThon.."boob"..data.sender_user_id,balas)
Redis:set(RunThon.."boobb"..data.sender_user_id,creditcc)
Redis:set(RunThon.."bbobb"..data.sender_user_id,mast)
Redis:set(RunThon.."boballname"..creditcc,news)
Redis:set(RunThon.."boballbalc"..creditcc,balas)
Redis:set(RunThon.."boballcc"..creditcc,creditcc)
Redis:set(RunThon.."boballban"..creditcc,mast)
Redis:set(RunThon.."boballid"..creditcc,banid)
Redis:sadd(RunThon.."booob",data.sender_user_id)
...
Redis:set(RunThon.."bobna"..data.sender_user_id,news)
Redis:set(RunThon.."boob"..data.sender_user_id,balas)
Redis:set(RunThon.."boobb"..data.sender_user_id,creditvi)
Redis:set(RunThon.."bbobb"..data.sender_user_id,visssa)
Redis:set(RunThon.."boballname"..creditvi,news)
Redis:set(RunThon.."boballbalc"..creditvi,balas)
Redis:set(RunThon.."boballcc"..creditvi,creditvi)
Redis:set(RunThon.."boballban"..creditvi,visssa)
Redis:set(RunThon.."boballid"..creditvi,banid)
Redis:sadd(RunThon.."booob",data.sender_user_id)
ttshakse = '⇜ اختر شخصيتك في اللعبة'
local reply_markup = bot.replyMarkup{
type = 'inline',
...
Redis:set(RunThon.."bobna"..data.sender_user_id,news)
Redis:set(RunThon.."boob"..data.sender_user_id,balas)
Redis:set(RunThon.."boobb"..data.sender_user_id,creditex)
Redis:set(RunThon.."bbobb"..data.sender_user_id,exprs)
Redis:set(RunThon.."boballname"..creditex,news)
Redis:set(RunThon.."boballbalc"..creditex,balas)
Redis:set(RunThon.."boballcc"..creditex,creditex)
Redis:set(RunThon.."boballban"..creditex,exprs)
Redis:set(RunThon.."boballid"..creditex,banid)
Redis:sadd(RunThon.."booob",data.sender_user_id)
ttshakse = '⇜ اختر شخصيتك في اللعبة'
local reply_markup = bot.replyMarkup{
type = 'inline',
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
cccall = Redis:get(RunThon.."tdbelballance"..data.sender_user_id) or 0
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
if tonumber(ballance) < tonumber(cccall) then
return edit(ChatId,Msg_id, "⇜ فلوسك ماتكفي","md",true)
end
Redis:setex(RunThon.."iioood" .. data.sender_user_id,920, true)
local list = {"1", "2", "3"}
local rand = list[math.random(#list)]
if rand == "1" then -- 1 con
cccallcc = tonumber(ballance) + tonumber(cccall)
Redis:set(RunThon.."boob"..data.sender_user_id,cccallcc)
Redis:del(RunThon.."tdbelballance"..data.sender_user_id)
...
cccallcc = tonumber(ballance) - tonumber(cccall)
Redis:set(RunThon.."boob"..data.sender_user_id,cccallcc)
cccall = Redis:get(RunThon.."tdbelballance"..data.sender_user_id)
Redis:del(RunThon.."tdbelballance"..data.sender_user_id)
local convert_mony = string.format("%.0f",cccall)
local convert_monyy = string.format("%.0f",cccallcc)
msalm = "⌯ خسرت بالسحب ☹️\n\n⇜ المبلغ : "..convert_mony.."\nرصيدك الان : `"..convert_monyy.."`\n✧"
...
Redis:set(RunThon.."boob"..data.sender_user_id,cccallcc)
namefram = Redis:get(RunThon.."namefram"..data.sender_user_id)
Redis:sadd(RunThon.."farmarname", namefram)
Redis:set(RunThon.."sizefram"..data.sender_user_id,50000)
Redis:sadd(RunThon.."ownerfram",data.sender_user_id)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
...
namefram = Redis:get(RunThon.."namefram"..data.sender_user_id)
Redis:sadd(RunThon.."farmarname", namefram)
Redis:set(RunThon.."sizefram"..data.sender_user_id,100000)
Redis:sadd(RunThon.."ownerfram",data.sender_user_id)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 8×8\n⇜ السعر : 100000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
namefram = Redis:get(RunThon.."namefram"..data.sender_user_id)
Redis:sadd(RunThon.."farmarname", namefram)
Redis:set(RunThon.."sizefram"..data.sender_user_id,200000)
Redis:sadd(RunThon.."ownerfram",data.sender_user_id)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 12×12\n⇜ السعر : 1000000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
namefram = Redis:get(RunThon.."namefram"..data.sender_user_id)
Redis:sadd(RunThon.."farmarname", namefram)
Redis:set(RunThon.."sizefram"..data.sender_user_id,300000)
Redis:sadd(RunThon.."ownerfram",data.sender_user_id)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 16×16\n⇜ السعر : 5000000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
namefram = Redis:get(RunThon.."namefram"..data.sender_user_id)
Redis:sadd(RunThon.."farmarname", namefram)
Redis:set(RunThon.."sizefram"..data.sender_user_id,400000)
Redis:sadd(RunThon.."ownerfram",data.sender_user_id)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 32×32\n⇜ السعر : 10000000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
if Redis:get(RunThon.."mrkzplayer".."1"..data.sender_user_id) then
return edit(ChatId,Msg_id, "⇜ لديك لاعب مركز هجوم\n⇜ ابحث عن لاعب اخر\n✧","md",true)
end
cccallcc = tonumber(ballance) - 39000
Redis:set(RunThon.."boob"..data.sender_user_id,cccallcc)
nameplayer = "رنثون سواريز"
energyplayer = "83"
mrkzplayer = "مهاجم"
cityplayer = "🇺🇦 اوكرانيا"
Redis:set(RunThon.."nameplayer".."1"..data.sender_user_id,nameplayer)
Redis:set(RunThon.."energyplayer".."1"..data.sender_user_id,energyplayer)
Redis:set(RunThon.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."1"..data.sender_user_id,39000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : رنثون سواريز\n⇜ مركزه : مهاجم\n⇜ طاقة اللاعب : 83\n⇜ الجنسية : اوكرانيا 🇺🇦\n⇜ السعر : 39000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
end
end
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
edit(ChatId,Msg_id,"⇜ تم الغاء شراء اللاعب رنثون سواريز ", 'md', true)
end
end
...
if Redis:get(RunThon.."mrkzplayer".."4"..data.sender_user_id) then
...
mrkzplayer = "مدافع"
cityplayer = "البرازيل 🇧🇷"
Redis:set(RunThon.."nameplayer".."4"..data.sender_user_id,nameplayer)
Redis:set(RunThon.."energyplayer".."4"..data.sender_user_id,energyplayer)
Redis:set(RunThon.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."4"..data.sender_user_id,50000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
if Redis:get(RunThon.."mrkzplayer".."3"..data.sender_user_id) then
...
Redis:set(RunThon.."nameplayer".."3"..data.sender_user_id,nameplayer)
Redis:set(RunThon.."energyplayer".."3"..data.sender_user_id,energyplayer)
Redis:set(RunThon.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."3"..data.sender_user_id,70000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."4"..data.sender_user_id,40000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."3"..data.sender_user_id,20000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : خوان ماتا\n⇜ مركزه : وسط\n⇜ طاقة اللاعب : 81\n⇜ الجنسية : إسبانيا 🇪🇸 \n⇜ السعر : 20000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(RunThon.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."4"..data.sender_user_id,15000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."1"..data.sender_user_id,100000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."4"..data.sender_user_id,20000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."4"..data.sender_user_id,30000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
if Redis:get(RunThon.."mrkzplayer".."5"..data.sender_user_id) then
...
mrkzplayer = "حارس"
cityplayer = "ألمانيا 🇩🇪 "
Redis:set(RunThon.."nameplayer".."5"..data.sender_user_id,nameplayer)
Redis:set(RunThon.."energyplayer".."5"..data.sender_user_id,energyplayer)
Redis:set(RunThon.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."5"..data.sender_user_id,110000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : تير شتيجن\n⇜ مركزه : حارس\n⇜ طاقة اللاعب : 91\n⇜ الجنسية : ألمانيا 🇩🇪 \n⇜ السعر : 110000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
if Redis:get(RunThon.."mrkzplayer".."2"..data.sender_user_id) then
...
mrkzplayer = "جناح"
cityplayer = "فرنسا 🇫🇷 "
Redis:set(RunThon.."nameplayer".."2"..data.sender_user_id,nameplayer)
Redis:set(RunThon.."energyplayer".."2"..data.sender_user_id,energyplayer)
Redis:set(RunThon.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."2"..data.sender_user_id,45000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."2"..data.sender_user_id,78000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : رودريغو\n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : البرازيل 🇧🇷\n⇜ السعر : 78000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(RunThon.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."4"..data.sender_user_id,65000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : ميليتاو\n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : البرازيل 🇧🇷\n⇜ السعر : 65000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(RunThon.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."4"..data.sender_user_id,73000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : الابا\n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : النمسا 🇦🇹 \n⇜ السعر : 73000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(RunThon.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."2"..data.sender_user_id,180000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : فينيسيوس \n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 94\n⇜ الجنسية : البرازيل 🇧🇷 \n⇜ السعر : 180000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(RunThon.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."2"..data.sender_user_id,55000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : دي ماريا \n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 85\n⇜ الجنسية : الأرجنتين 🇦🇷 \n⇜ السعر : 55000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(RunThon.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."4"..data.sender_user_id,38000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : دانييلي \n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 84\n⇜ الجنسية : إيطاليا 🇮🇹 \n⇜ السعر : 38000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(RunThon.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."1"..data.sender_user_id,55000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."5"..data.sender_user_id,99000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : دوناروما \n⇜ مركزه : حارس\n⇜ طاقة اللاعب : 89\n⇜ الجنسية : إيطاليا 🇮🇹 \n⇜ السعر : 99000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(RunThon.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."4"..data.sender_user_id,55000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."2"..data.sender_user_id,59000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."4"..data.sender_user_id,170000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : ايدن ازارد \n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 93\n⇜ الجنسية : اسبانيا 🇪🇸 \n⇜ السعر : 170000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(RunThon.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."1"..data.sender_user_id,60000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : فرمينو \n⇜ مركزه : مهاجم\n⇜ طاقة اللاعب : 86\n⇜ الجنسية : البرازيل 🇧🇷 \n⇜ السعر : 60000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(RunThon.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."1"..data.sender_user_id,19000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : جاك كلارك \n⇜ مركزه : مهاجم\n⇜ طاقة اللاعب : 81\n⇜ الجنسية : إنجلترا 🏴󠁧󠁢󠁥󠁮󠁧󠁿 \n⇜ السعر : 19000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(RunThon.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."1"..data.sender_user_id,53000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."1"..data.sender_user_id,41000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : توريس \n⇜ مركزه : مهاجم\n⇜ طاقة اللاعب : 84\n⇜ الجنسية : اسبانيا 🇪🇸 \n⇜ السعر : 41000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(RunThon.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."3"..data.sender_user_id,41000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."3"..data.sender_user_id,74000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."3"..data.sender_user_id,78000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : بول بوجبا \n⇜ مركزه : وسط\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : فرنسا 🇫🇷 \n⇜ السعر : 78000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(RunThon.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."3"..data.sender_user_id,90000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."5"..data.sender_user_id,80000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."5"..data.sender_user_id,70000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."5"..data.sender_user_id,52000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."5"..data.sender_user_id,20000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."5"..data.sender_user_id,40000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."1"..data.sender_user_id,20000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."2"..data.sender_user_id,100000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : محمد صلاح\n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 91\n⇜ الجنسية : مصر 🇪🇬 \n⇜ السعر : 100000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(RunThon.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."2"..data.sender_user_id,90000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : نيمار\n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 90\n⇜ الجنسية : السنغال 🇸🇳 \n⇜ السعر : 90000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(RunThon.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(RunThon.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(RunThon.."priceplayer".."2"..data.sender_user_id,80000)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."boob"..data.sender_user_id,cccallcc)
lkbnade = Redis:get(RunThon.."lkbnade"..data.sender_user_id)
Redis:sadd(RunThon.."lkbnadesadd", lkbnade)
namenade = "ريال مدريد"
Redis:set(RunThon.."namenade"..data.sender_user_id,namenade)
Redis:set(RunThon.."nokatnade"..data.sender_user_id,0)
Redis:sadd(RunThon.."ownernade",data.sender_user_id)
Redis:set(RunThon.."energynade"..data.sender_user_id,50)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."nokatnade"..data.sender_user_id,0)
Redis:sadd(RunThon.."ownernade",data.sender_user_id)
Redis:set(RunThon.."energynade"..data.sender_user_id,45)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : برشلونة\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 150000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(RunThon.."nokatnade"..data.sender_user_id,0)
Redis:sadd(RunThon.."ownernade",data.sender_user_id)
Redis:set(RunThon.."energynade"..data.sender_user_id,40)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : تشيلسي\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 90000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(RunThon.."nokatnade"..data.sender_user_id,0)
Redis:sadd(RunThon.."ownernade",data.sender_user_id)
Redis:set(RunThon.."energynade"..data.sender_user_id,35)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."nokatnade"..data.sender_user_id,0)
Redis:sadd(RunThon.."ownernade",data.sender_user_id)
Redis:set(RunThon.."energynade"..data.sender_user_id,30)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : ليفربول\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 120000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(RunThon.."nokatnade"..data.sender_user_id,0)
Redis:sadd(RunThon.."ownernade",data.sender_user_id)
Redis:set(RunThon.."energynade"..data.sender_user_id,25)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."nokatnade"..data.sender_user_id,0)
Redis:sadd(RunThon.."ownernade",data.sender_user_id)
Redis:set(RunThon.."energynade"..data.sender_user_id,20)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(RunThon.."nokatnade"..data.sender_user_id,0)
Redis:sadd(RunThon.."ownernade",data.sender_user_id)
Redis:set(RunThon.."energynade"..data.sender_user_id,15)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : يوفنتوس\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 40000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(RunThon.."nokatnade"..data.sender_user_id,0)
Redis:sadd(RunThon.."ownernade",data.sender_user_id)
Redis:set(RunThon.."energynade"..data.sender_user_id,10)
ballance = Redis:get(RunThon.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : ارسنال\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 20000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
if Redis:get(RunThon.."hazrlock"..ChatId) == UserId then
if Redis:sismember(RunThon.."listhzerid"..ChatId, IdUser) then
return bot.answerCallbackQuery(data.id, "⇜ لقد انضممت الى اللعبة مسبقاً ", true)
end
if tonumber(Redis:get(RunThon.."hazrmalek"..ChatId)) == IdUser then
return bot.answerCallbackQuery(data.id, "⇜ انتا مالك اللعبة حاليا", true)
end
Redis:sadd(RunThon.."listhzerid"..ChatId, IdUser)
...
if Redis:get(RunThon.."soundidche"..ChatId..IdUser) == UserId[1] then
...
sleep(1)
os.remove(""..title..".mp3")
Redis:del(RunThon.."soundidche"..ChatId..IdUser)
else
Redis:del(RunThon.."soundidche"..ChatId..IdUser)
...
if Redis:get(RunThon.."youtidche"..ChatId..IdUser) == UserId[1] then
...
sleep(1)
os.remove(""..title..".mp3")
Redis:del(RunThon.."youtidche"..ChatId..IdUser)
else
Redis:del(RunThon.."youtidche"..ChatId..IdUser)
return edit(ChatId,Msg_id,'\n⇜ لا استطيع تحميل اكثر من 25 ميغا',"md",true)
end
...
local kk_id = Redis:get(RunThon.."kk_Akab"..ChatId)
if Redis:sismember(RunThon..'members_Ahkamm'..ChatId,IdUser) then
Redis:sadd(RunThon.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
local kk_id = Redis:get(RunThon.."kk_Akab"..ChatId)
if Redis:sismember(RunThon..'members_Ahkamm'..ChatId,IdUser) then
Redis:srem(RunThon.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{{text = '𝗦𝗢𝗨𝗥𝗖𝗘 𝗥𝗨𝗡𝗧𝗛𝗢𝗡', url = 't.me/xLxLxLrr3'},},}}
...
local ff_id = Redis:get(RunThon.."ff_Ahkam"..ChatId)
local kk_id = Redis:get(RunThon.."kk_Ahkam"..ChatId)
...
local ff_id = Redis:get(RunThon.."ff_Ahkkam"..ChatId)
local kk_id = Redis:get(RunThon.."kk_Ahkkam"..ChatId)
if tonumber(IdUser) == tonumber(ff_id) then
Redis:sadd(RunThon.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
...
local kk_id = Redis:get(RunThon.."kk_koorsi"..ChatId)
if Redis:sismember(RunThon..'List_Koorsi'..ChatId,IdUser) then
Redis:sadd(RunThon.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
local ff_id = Redis:get(RunThon.."ff_saraha"..ChatId)
local kk_id = Redis:get(RunThon.."kk_saraha"..ChatId)
if tonumber(IdUser) == tonumber(ff_id) then
Redis:sadd(RunThon.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
...
if not Redis:sismember(RunThon..'List_Aktooh'..ChatId,IdUser) then 
Redis:sadd(RunThon..'List_Aktooh'..ChatId,IdUser)
Redis:setex(RunThon.."Witting_StartGameAk"..ChatId,1400,true)
local list = Redis:smembers(RunThon..'List_Aktooh'..ChatId) 
if #list == 2 then
for k,v in pairs(list) do
if k == 1 then
...
if k == #list then
local Ak_Tm = Redis:get(RunThon.."Ak_Tmooh"..ChatId)
local ban = bot.getUser(Ak_Tm)
local AkName = '['..ban.first_name..'](tg://user?id='..ban.id..')' or 'لا يوجد اسم'
local message = '*✦┊عـدد المصـوتين ⇜*'..#list..' \n*✦┊اسمـاء المصـوتين ⇩*\n'..name1..'\n'..name2..'\n'..name3..'\n\n*✦┊المستخـدم* '..AkName..'\n*✦┊تم كتمـه .. بنجـاح ✓*'
Redis:sadd(RunThon.."SilentGroup:Group"..ChatId,Ak_Tm) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
---------------------- Dev ZilZal ----------------------
if Text == '/Unaktmooh' and Redis:get(RunThon.."Witting_StartGameAk"..ChatId) then
local raeaktooh = Redis:get(RunThon.."raeaktooh"..ChatId)
...
Redis:srem(RunThon.."SilentGroup:Group"..ChatId,Ak_Tm)
Redis:srem(RunThon..'List_Aktooh'..ChatId,UserName) 
Redis:del(RunThon..'raeaktooh'..ChatId) 
Redis:del(RunThon..'List_Aktooh'..ChatId) 
Redis:del(RunThon.."Witting_StartGameAk"..ChatId)
Redis:del(RunThon.."Start_Aktmooh"..ChatId)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
if not Redis:sismember(RunThon..'List_Ahkkam'..ChatId,IdUser) then 
Redis:sadd(RunThon..'List_Ahkkam'..ChatId,IdUser)
Redis:setex(RunThon.."Witting_StartGameeh"..ChatId,1400,true)
local list = Redis:smembers(RunThon..'List_Ahkkam'..ChatId) 
if #list == 2 then
local UserInfo = bot.getUser(IdUser)
...
---------------------- Dev ZilZal ----------------------
if Text == '/startahkam' and Redis:get(RunThon.."Witting_StartGameeh"..ChatId) then
local rarahkam = Redis:get(RunThon.."raeahkkam"..ChatId)
...
Redis:set(RunThon.."kk_Ahkkam"..ChatId,UserId_Info.id)
Redis:srem(RunThon..'List_Ahkkam'..ChatId,UserName) 
local liiist = Redis:smembers(RunThon..'List_Ahkkam'..ChatId) 
...
Redis:set(RunThon.."ff_Ahkkam"..ChatId,UserId2_Info.id)
local GetLike = Redis:incrby(RunThon.."Num:Add:Ahkam"..ChatId..UserId2_Info.id, 5) 
Redis:hset(RunThon..':GroupUserCountAhkam:'..ChatId,UserId2_Info.id,GetLike)
...
NameLUser = NameLUser:gsub("[[]","")
Redis:hset(RunThon..':GroupAhkamNameUser:'..ChatId,UserrInfo.id,NameLUser)
Redis:del(RunThon..'raeahkkam'..ChatId) 
Redis:del(RunThon..'List_Ahkkam'..ChatId) 
Redis:del(RunThon.."Witting_StartGameeh"..ChatId)
Redis:del(RunThon.."Start_Ahkkam"..ChatId)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
---------------------- Dev ZilZal ----------------------
if Text == '/Koorsy' then
if not Redis:sismember(RunThon..'List_Koorsi'..ChatId,IdUser) then 
Redis:sadd(RunThon..'List_Koorsi'..ChatId,IdUser)
Redis:setex(RunThon.."Witting_StartGameek"..ChatId,1400,true)
local list = Redis:smembers(RunThon..'List_Koorsi'..ChatId) 
if #list == 2 then
local UserInfo = bot.getUser(IdUser)
local Teext = '- ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..IdUser..')'
...
---------------------- Dev ZilZal ----------------------
if Text == '/startkoorsi' and Redis:get(RunThon.."Witting_StartGameek"..ChatId) then
local rarahkam = Redis:get(RunThon.."raekoorsi"..ChatId)
if tonumber(IdUser) == tonumber(rarahkam) then
local list = Redis:smembers(RunThon..'List_Koorsi'..ChatId) 
local UserName = list[math.random(#list)]
local UserId_Info = bot.getUser(UserName)
...
Redis:set(RunThon.."koorsi:"..testkoorsi.."chat_id", ChatId)
Redis:set(RunThon.."koorsi:"..testkoorsi.."to", UserId_Info.id)
Redis:set(RunThon.."koorsi:"..testkoorsi.."msg_id",Msg_id)
if UserId_Info.username and UserId_Info.username ~= "" then
ls = '['..UserId_Info.first_name..'](tg://user?id='..UserName..')'
else
ls = '['..UserId_Info.first_name..'](tg://user?id='..UserName..')'
end
Redis:set(RunThon.."kk_koorsi"..ChatId,UserId_Info.id)
Redis:srem(RunThon..'List_Koorsi'..ChatId,UserName) 
Redis:del(RunThon..'raekoorsi'..ChatId) 
Redis:del(RunThon..'List_Koorsi'..ChatId) 
Redis:del(RunThon.."Witting_StartGameek"..ChatId)
Redis:del(RunThon.."Start_Koorsi"..ChatId)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(RunThon..'List_Saraha'..ChatId,IdUser) then 
Redis:sadd(RunThon..'List_Saraha'..ChatId,IdUser)
Redis:setex(RunThon.."Witting_StartGameS"..ChatId,1400,true)
local list = Redis:smembers(RunThon..'List_Saraha'..ChatId) 
if #list == 2 then
local UserInfo = bot.getUser(IdUser)
local Teext = '- ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..IdUser..')'
local zzllzz = '*✦┊عـدد اللاعبيـن ⇜*'..#list..' \n*✦┊لقـد انضـم للعبـة كرسـي ⇩*\n'..Teext
...
---------------------- صراحه ----------------------
if Text == '/startsaraha' and Redis:get(RunThon.."Witting_StartGameS"..ChatId) then
local rarahkam = Redis:get(RunThon.."raesaraha"..ChatId)
if tonumber(IdUser) == tonumber(rarahkam) then
local list = Redis:smembers(RunThon..'List_Saraha'..ChatId) 
local UserName = list[math.random(#list)]
local UserId_Info = bot.getUser(UserName)
local testsaraha = math.random(1,9999999999999)
Redis:set(RunThon.."saraha:"..testsaraha.."chat_id", ChatId)
Redis:set(RunThon.."saraha:"..testsaraha.."to", UserId_Info.id)
Redis:set(RunThon.."saraha:"..testsaraha.."msg_id",Msg_id)
if UserId_Info.username and UserId_Info.username ~= "" then
ls = '['..UserId_Info.first_name..'](tg://user?id='..UserName..')'
else
ls = '['..UserId_Info.first_name..'](tg://user?id='..UserName..')'
end
Redis:set(RunThon.."kk_saraha"..ChatId,UserId_Info.id)
Redis:srem(RunThon..'List_Saraha'..ChatId,UserName) 
local liiiist = Redis:smembers(RunThon..'List_Saraha'..ChatId) 
local User2Name = liiiist[math.random(#liiiist)]
local UserId2_Info = bot.getUser(User2Name)
Redis:incrby(RunThon..'Num:Add:Games'..ChatId..UserId2_Info.id,5)
Redis:set(RunThon.."ff_saraha"..ChatId,UserId2_Info.id)
Redis:del(RunThon..'raesaraha'..ChatId) 
Redis:del(RunThon..'List_Saraha'..ChatId) 
Redis:del(RunThon.."Witting_StartGameS"..ChatId)
Redis:del(RunThon.."Start_Saraha"..ChatId)
local liiist = Redis:sismember(RunThon..'List_Saraha'..ChatId,IdUser)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:sismember(RunThon..'List_Ahkamm'..ChatId,IdUser) then
return bot.answerCallbackQuery(data.id, "✦┊انت منضـم مسبقـاً .. الـى اللعبـه", true)
end
bot.answerCallbackQuery(data.id, "✦ تم ضفتك للعبـة ⛓ ✓", true)
Redis:sadd(RunThon..'List_Ahkamm'..ChatId,IdUser)
Redis:sadd(RunThon..'members_Ahkamm'..ChatId,IdUser)
Redis:setex(RunThon.."Witting_StartGamehh"..ChatId,1400,true)
end
if Text and Text:match('/Ahkam(.*)') then
local UserId = Text:match('/Ahkam(.*)')
if Redis:sismember(RunThon..'List_Ahkam'..ChatId,IdUser) then
return bot.answerCallbackQuery(data.id, "✦┊انت منضـم مسبقـاً .. الـى اللعبـه", true)
end
bot.answerCallbackQuery(data.id, "✦ تم ضفتك للعبـة 👩🏻‍⚖⚖ ✓", true)
Redis:sadd(RunThon..'List_Ahkam'..ChatId,IdUser)
Redis:setex(RunThon.."Witting_StartGameh"..ChatId,1400,true)
end
if Text and Text:match('/Korsy(.*)') then
local UserId = Text:match('/Korsy(.*)')
if Redis:sismember(RunThon..'List_Korsi'..ChatId,IdUser) then
return bot.answerCallbackQuery(data.id, "✦┊انت منضـم مسبقـاً .. الـى اللعبـه", true)
end
bot.answerCallbackQuery(data.id, "✦ تم ضفتك للعبـة ⛓ ✓", true)
Redis:sadd(RunThon..'List_Korsi'..ChatId,IdUser)
Redis:setex(RunThon.."Witting_StartGamek"..ChatId,1400,true)
end
if Text and Text:match('/Sarahy(.*)') then
local UserId = Text:match('/Sarahy(.*)')
if Redis:sismember(RunThon..'List_Saraha'..ChatId,IdUser) then
return bot.answerCallbackQuery(data.id, "✦┊انت منضـم مسبقـاً .. الـى اللعبـه", true)
end
bot.answerCallbackQuery(data.id, "✦ تم ضفتك للعبـة ⛓ ✓", true)
Redis:sadd(RunThon..'List_Saraha'..ChatId,IdUser)
...
if Text and Text:match('(%d+)/startttahkam') and Redis:get(RunThon.."Witting_StartGameh"..ChatId) then
local UserId = Text:match('(%d+)/startttahkam')
local rarahkam = Redis:get(RunThon.."raeahkam"..ChatId)
if tonumber(IdUser) ~= tonumber(rarahkam) then
return bot.answerCallbackQuery(data.id, "✦┊الامـر للي بـدأ اللعبـه ...", true)
else
local list = Redis:smembers(RunThon..'List_Ahkam'..ChatId) 
local UserName = list[math.random(#list)]
local UserId_Info = bot.getUser(UserName)
if UserId_Info.username and UserId_Info.username ~= "" then
ls = '['..UserId_Info.first_name..'](tg://user?id='..UserName..')'
...
Redis:set(RunThon.."kk_Ahkam"..ChatId,UserId_Info.id)
Redis:srem(RunThon..'List_Ahkam'..ChatId,UserId_Info.id) 
...
Redis:set(RunThon.."ff_Ahkam"..ChatId,UserId2_Info.id)
Redis:incrby(RunThon..'Num:Add:Ahkam'..ChatId..UserId2_Info.id,5)
Redis:del(RunThon..'raeahkam'..ChatId) 
Redis:del(RunThon..'List_Ahkam'..ChatId) 
Redis:del(RunThon.."Witting_StartGameh"..ChatId)
Redis:del(RunThon.."Start_Ahkam"..ChatId)
local RunThon = '*⚖┊تم إختيار الشخـص ⇜* '..ls..'\n*👩🏻‍⚖┊ليتـم الحكـم عليـه من قبـل ⇜* '..Hs..'\n\n*🎁┊وتم اضـافـة 5 نقـاط للحـاكـم*'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹𓌗 قنـاة البـوت 𓌗.',url='http://t.me/'..chsource..''}},
}
local msg_idd = Msg_id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token..'/editMessageText?chat_id='..data.id..'&text='..URL.escape(RunThon)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Spam"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Keyboard"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:vico"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Animation"..ChatId,"del")
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Document"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:text"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Video"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Photo"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:User:Name"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:hashtak"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:forward"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Audio"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Sticker"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Contact"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Join"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Unsupported"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:lockpin"..ChatId,(bot.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:tagservr"..ChatId,true)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Markdaun"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:edit"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:geam"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(RunThon.."TheRunThon:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Link"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Spam"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:vico"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Animation"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Document"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Video"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Photo"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:User:Name"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:hashtak"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:forward"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Audio"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Sticker"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Contact"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:geam"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(RunThon.."TheRunThon:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Link"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Spam"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:vico"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Animation"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Document"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Video"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Photo"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:forward"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Audio"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Contact"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:geam"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(RunThon.."TheRunThon:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Link"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Spam"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:vico"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Animation"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Document"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Video"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Photo"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:User:Name"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:hashtak"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:forward"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Audio"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Sticker"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Contact"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:geam"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(RunThon.."TheRunThon:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Status:Link"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Status:Welcome"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Status:Id"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Status:IdPhoto"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Status:Reply"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Status:ReplySudo"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Status:SetId"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Status:BanId"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Status:Games"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Status:KickMe"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Status:Link"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Status:Welcome"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Status:Id"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Status:IdPhoto"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Status:Reply"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Status:ReplySudo"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Status:SetId"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Status:BanId"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Status:Games"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Status:KickMe"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(RunThon.."TheRunThon:TheBasicsQ:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(RunThon.."TheRunThon:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(RunThon.."TheRunThon:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(RunThon..'TheRunThon:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'ا','ايدي')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'م','رفع مميز')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'اد', 'رفع ادمن')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'مد','رفع مدير')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'منش', 'رفع منشئ')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'اس', 'رفع منشئ اساسي')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'مط','رفع M')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'تن','تنزيل الكل')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'را','الرابط')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'رر','الردود')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'،،','مسح المكتومين')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'رد','اضف رد')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'غ','غنيلي')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'رس','رسائلي')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'ثانوي','رفع مطور ثانوي')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'مس','مسح تعديلاتي')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'ن','نقاطي')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'س','اسالني')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'ل','لغز')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'مع','معاني')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'ح','حزوره')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'رف','رفع القيود')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'الغ','الغاء حظر')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'ث','تثبيت')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'ك','كشف')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'تت','تاك')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'تك','تاك للكل')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'تغ','تغيير الايدي')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'تنز','تنزيل جميع الرتب')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'قق','قفل الاشعارات')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'فف','فتح الاشعارات')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'مر','مسح رد')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'امر','اضف امر')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'ش','شعر')
Redis:set(RunThon.."TheRunThon:Get:Reides:Commands:Group"..UserId[2]..":"..'غغ','اغنيه')
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:Link"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:farsia"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:tphlesh"..ChatId)  
Redis:del(RunThon.."TheRunThon:Status:IdPhoto"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:phshar"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:farsia"..ChatId,true)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:tphlesh"..ChatId,true)
Redis:set(RunThon.."TheRunThon:Status:IdPhoto"..ChatId,true)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RunThon.."TheRunThon:Lock:phshar"..ChatId,true)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:Spam"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:Keyboard"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:vico"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:Animation"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:Document"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:text"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:Video"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:Photo"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:User:Name"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:hashtak"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:Bot:kick"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:forward"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:Audio"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:Sticker"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:Contact"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:Join"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:AddMempar"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:Unsupported"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:lockpin"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:tagservr"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:Markdaun"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:edit"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Lock:geam"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(RunThon.."TheRunThon:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:DevelopersQ:Groups") 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Developers:Groups") 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:ControlAll:Groups") 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:TheBasicsQ:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:MalekAsase:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:TheBasics:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Originators:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Managers:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Addictive:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:Distinguished:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:KtmAll:Groups") 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:BanAll:Groups") 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:BanGroup:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RunThon.."TheRunThon:SilentGroup:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
