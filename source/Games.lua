...
Bot_Name = (Redis:get(RunThon.."TheRunThon:Name:Bot") or "رنثون")
if text and text:match('^'..Bot_Name..' ') then
text = text:gsub('^'..Bot_Name..' ','')
end
if text then
local NewCmmd = Redis:get(RunThon.."All:Get:Reides:Commands:Group"..text) or Redis:get(RunThon.."TheRunThon:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
text = (NewCmmd or text)
end
end
if Redis:get(RunThon.."TheRunThon:Game:Smile"..msg.chat_id) then
if text == Redis:get(RunThon.."TheRunThon:Game:Smile"..msg.chat_id) then
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
Redis:del(RunThon.."TheRunThon:Game:Smile"..msg.chat_id)
local Num = Redis:get(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true)  
end
end 
if Redis:get(RunThon.."TheRunThon:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(RunThon.."TheRunThon:Game:Monotonous"..msg.chat_id) then
Redis:del(RunThon.."TheRunThon:Game:Monotonous"..msg.chat_id)
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
end 
if Redis:get(RunThon.."TheRunThon:Game:alam"..msg.chat_id) then
if text == Redis:get(RunThon.."TheRunThon:Game:alam"..msg.chat_id) then
Redis:del(RunThon.."TheRunThon:Game:alam"..msg.chat_id)
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
end 
if Redis:get(RunThon.."TheRunThon:Game:ausm"..msg.chat_id) then
if text == Redis:get(RunThon.."TheRunThon:Game:ausm"..msg.chat_id) then
Redis:del(RunThon.."TheRunThon:Game:ausm"..msg.chat_id)
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
end 
if Redis:get(RunThon.."TheRunThon:Game:Riddles"..msg.chat_id) then
if text == Redis:get(RunThon.."TheRunThon:Game:Riddles"..msg.chat_id) then
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
Redis:del(RunThon.."TheRunThon:Game:Riddles"..msg.chat_id)
local Num = Redis:get(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
end
if Redis:get(RunThon.."TheRunThon:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(RunThon.."TheRunThon:Game:Meaningof"..msg.chat_id) then
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
Redis:del(RunThon.."TheRunThon:Game:Meaningof"..msg.chat_id)
local Num = Redis:get(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
end
if Redis:get(RunThon.."TheRunThon:Game:Reflection"..msg.chat_id) then
if text == Redis:get(RunThon.."TheRunThon:Game:Reflection"..msg.chat_id) then
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
Redis:del(RunThon.."TheRunThon:Game:Reflection"..msg.chat_id)
local Num = Redis:get(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
end
if Redis:get(RunThon.."TheRunThon:Game:Estimate"..msg.chat_id..msg.sender_id.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return send(msg_chat_id,msg_id,"⇜ مايمديك تخمن عدد اكبر من ( 20 ) خمن رقم ما بين ( 1 - 20 )\n","md",true)
end 
local GETNUM = Redis:get(RunThon.."TheRunThon:Game:Estimate"..msg.chat_id..msg.sender_id.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(RunThon.."TheRunThon:SADD:NUM"..msg.chat_id..msg.sender_id.user_id)
Redis:del(RunThon.."TheRunThon:Game:Estimate"..msg.chat_id..msg.sender_id.user_id)
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id,5)  
return send(msg_chat_id,msg_id,"⇜ مبروك فزت وخمنت الرقم الصحيح\n⇜ تم اضافة لك ( 5 ) نقاط \n✧","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(RunThon.."TheRunThon:SADD:NUM"..msg.chat_id..msg.sender_id.user_id,1)
if tonumber(Redis:get(RunThon.."TheRunThon:SADD:NUM"..msg.chat_id..msg.sender_id.user_id)) >= 3 then
Redis:del(RunThon.."TheRunThon:SADD:NUM"..msg.chat_id..msg.sender_id.user_id)
Redis:del(RunThon.."TheRunThon:Game:Estimate"..msg.chat_id..msg.sender_id.user_id)
...
if Redis:get(RunThon.."TheRunThon:Game:Difference"..msg.chat_id) then
if text == Redis:get(RunThon.."TheRunThon:Game:Difference"..msg.chat_id) then 
Redis:del(RunThon.."TheRunThon:Game:Difference"..msg.chat_id)
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
end
if Redis:get(RunThon.."TheRunThon:Game:Example"..msg.chat_id) then
if text == Redis:get(RunThon.."TheRunThon:Game:Example"..msg.chat_id) then 
Redis:del(RunThon.."TheRunThon:Game:Example"..msg.chat_id)
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
...
if Redis:get(RunThon.."gamebot:Set:Manager:rd"..msg.sender_id.user_id..":"..msg.chat_id) == "true" then
Redis:set(RunThon.."gamebot:Set:Manager:rd"..msg.sender_id.user_id..":"..msg.chat_id,"true1uu")
Redis:sadd(RunThon.."gamebot:List:Manager", text)
return send(msg.chat_id,msg.id,'\n⇜ تم حفظ السؤال')
end
end
if text and text:match("^(.*)$") then
if Redis:get(RunThon.."gamebot:Set:Manager:rdd"..msg.sender_id.user_id..":"..msg.chat_id) == "true" then
Redis:set(RunThon.."gamebot:Set:Manager:rdd"..msg.sender_id.user_id..":"..msg.chat_id,"true1uu")
Redis:srem(RunThon.."gamebot:List:Manager", text)
return send(msg.chat_id,msg.id,'\n⇜ تم مسح السؤال')
end
end
if Redis:get(RunThon.."Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'start' then
if msg.content.audio then  
Redis:set(RunThon.."audio:Games"..msg.sender_id.user_id..":"..msg.chat_id,msg.content.audio.audio.remote.id)  
Redis:sadd(RunThon.."audio:Games:Bot",msg.content.audio.audio.remote.id)  
Redis:set(RunThon.."Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id,'started')
return send(msg.chat_id, msg.id,'⇜ ارسل الجواب الان ...')
end   
end
if Redis:get(RunThon.."Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'started' then
local Id_audio = Redis:get(RunThon.."audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
Redis:set(RunThon..'Text:Games:audio'..Id_audio,text)
Redis:del(RunThon.."Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
return send(msg.chat_id, msg.id,'⇜ تم حفظ السؤال والجواب')
end

if Redis:get(RunThon..'Games:Set:Answer'..msg.chat_id) then
if text == ""..(Redis:get(RunThon..'Games:Set:Answer'..msg.chat_id) or '66765$47').."" then 
Redis:del(RunThon.."Games:Set:Answer"..msg.chat_id)
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id,5)  
Redis:del(RunThon.."Games:Set:Answer"..msg.chat_id)
local Num = Redis:get(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك ( 5 ) نقاط\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
...
if Redis:get(RunThon.."TheRunThon:All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'startdel' then
if not Redis:sismember(RunThon.."TheRunThon:All:text:Games:Bot",text) then
send(msg_chat_id,msg_id,'⇜ لا يوجد صوت بهذا الاسم عام')
Redis:del(RunThon.."TheRunThon:All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
return false
end
Redis:del(RunThon.."TheRunThon:All:audio:Games"..text)
Redis:srem(RunThon.."TheRunThon:All:text:Games:Bot",text)  
Redis:del(RunThon.."TheRunThon:All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
send(msg_chat_id,msg_id,'⇜ تم مسح الصوت بنجاح')
return false
end
if Redis:get(RunThon.."TheRunThon:All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'start' then
Redis:set(RunThon..'TheRunThon:All:Text:Games:audio'..msg.chat_id,text)
Redis:sadd(RunThon.."TheRunThon:All:text:Games:Bot",text)  
Redis:set(RunThon.."TheRunThon:All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id,'started')
send(msg_chat_id,msg_id,'⇜ ارسل الصوت ليتم حفظه باسم : '..text)
return false
end
if Redis:get(RunThon.."TheRunThon:All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'started' then
if msg.content.audio then  
local nameaudio = Redis:get(RunThon..'TheRunThon:All:Text:Games:audio'..msg.chat_id)
Redis:set(RunThon.."TheRunThon:All:audio:Games"..nameaudio,msg.content.audio.audio.remote.id)  
Redis:del(RunThon.."TheRunThon:All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
send(msg_chat_id,msg_id,'⇜ تم حفظ الصوت باسم : '..nameaudio)
return false
end   
end
if text and not Redis:get(RunThon..'lock_geamsAudio'..msg.chat_id) then
local nameaudio = Redis:get(RunThon.."TheRunThon:All:audio:Games"..text)
if nameaudio then
bot.sendAudio(msg_chat_id, msg.id,nameaudio , '', "md") 
end
end
if Redis:get(RunThon.."TheRunThon:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'startdel' then
if not Redis:sismember(RunThon.."TheRunThon:text:Games:Bot"..msg.chat_id,text) then
send(msg_chat_id,msg_id,'⇜ لا يوجد صوت بهذا الاسم في القروب')
Redis:del(RunThon.."TheRunThon:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
return false
end
Redis:del(RunThon.."TheRunThon:audio:Games"..msg.chat_id..text)
Redis:srem(RunThon.."TheRunThon:text:Games:Bot"..msg.chat_id,text)  
Redis:del(RunThon.."TheRunThon:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
send(msg_chat_id,msg_id,'⇜ تم مسح الصوت بنجاح')
return false
end
if Redis:get(RunThon.."TheRunThon:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'start' then
Redis:set(RunThon..'TheRunThon:Text:Games:audio'..msg.chat_id,text)
Redis:sadd(RunThon.."TheRunThon:text:Games:Bot"..msg.chat_id,text)  
Redis:set(RunThon.."TheRunThon:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id,'started')
send(msg_chat_id,msg_id,'⇜ ارسل الصوت ليتم حفضه باسم : '..text)
return false
end
if Redis:get(RunThon.."TheRunThon:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'started' then
if msg.content.audio then  
local nameaudio = Redis:get(RunThon..'TheRunThon:Text:Games:audio'..msg.chat_id)
Redis:set(RunThon.."TheRunThon:audio:Games"..msg.chat_id..nameaudio,msg.content.audio.audio.remote.id)  
Redis:del(RunThon.."TheRunThon:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
send(msg_chat_id,msg_id,'⇜ تم حفظ الصوت باسم : '..nameaudio)
return false
end   
end
if text and not Redis:get(RunThon..'lock_geamsAudio1'..msg.chat_id) then
local nameaudio = Redis:get(RunThon.."TheRunThon:audio:Games"..msg.chat_id..text)
if nameaudio then
bot.sendAudio(msg_chat_id, msg.id,nameaudio , '', "md") 
end
end
if text and text:match("^(.*)$") then
if Redis:get(RunThon.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "truedel" then
Redis:set(RunThon.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"truefguigf1")
Redis:del(RunThon.."gamebot:newqus"..msg.chat_id,text)
Redis:srem(RunThon.."gamebot:new1", text)
return send(msg_chat_id,msg_id, '\nتم مسح السؤال') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(RunThon.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true" then
Redis:set(RunThon.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true1")
Redis:set(RunThon.."gamebot:newqus"..msg.chat_id,text)
Redis:sadd(RunThon.."gamebot:new1", text)
return send(msg_chat_id,msg_id, '\n⇜ تم حفظ السؤال \n⇜ ارسل الجواب الاول') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(RunThon.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true1" then
local quschen = Redis:get(RunThon.."gamebot:newqus"..msg.chat_id)
Redis:set(RunThon.."gamebot:newqus:as1"..quschen,text)
Redis:set(RunThon.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true2")
return send(msg_chat_id,msg_id, ' \n⇜ ارسل الجواب الثاني') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(RunThon.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true2" then
local quschen = Redis:get(RunThon.."gamebot:newqus"..msg.chat_id)
Redis:set(RunThon.."gamebot:newqus:as2"..quschen,text)
Redis:set(RunThon.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true3")
return send(msg_chat_id,msg_id, '\n⇜ ارسل الجواب الثالث') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(RunThon.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true3" then
local quschen = Redis:get(RunThon.."gamebot:newqus"..msg.chat_id)
Redis:set(RunThon.."gamebot:newqus:as3"..quschen,text)
Redis:set(RunThon.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true4")
return send(msg_chat_id,msg_id, '\n⇜ ارسل الجواب الرابع') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(RunThon.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true4" then
local quschen = Redis:get(RunThon.."gamebot:newqus"..msg.chat_id)
Redis:set(RunThon.."gamebot:newqus:as0"..quschen,text)
Redis:set(RunThon.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true44")
return send(msg_chat_id,msg_id, '\n⇜ تم حفظ الاجوبة \n⇜ ارسل الجواب الصحيح') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(RunThon.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true44" then
local quschen = Redis:get(RunThon.."gamebot:newqus"..msg.chat_id)
Redis:set(RunThon.."gamebot:newqus:as4"..quschen,text)
Redis:set(RunThon.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true186")
return send(msg_chat_id,msg_id, '\n⇜ تم حفظ الجواب الصحيح') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(RunThon.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "truedel" then
send(msg_chat_id,msg_id, '\n⇜ تم مسح الغز ')
Redis:set(RunThon.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"truefguigf1")
Redis:del(RunThon.."lkz:gamebot:newqus"..msg.chat_id,text)
Redis:srem(RunThon.."lkz:gamebot:new1", text)
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(RunThon.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true" then
send(msg_chat_id,msg_id, '\n⇜ تم حفظ اللغز \n⇜ ارسل الجواب الاول')
Redis:set(RunThon.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true1")
Redis:set(RunThon.."lkz:gamebot:newqus"..msg.chat_id,text)
Redis:sadd(RunThon.."lkz:gamebot:new1", text)
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(RunThon.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true1" then
send(msg_chat_id,msg_id, ' \n⇜ ارسل الجواب الثاني')
local quschen = Redis:get(RunThon.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(RunThon.."lkz:gamebot:newqus:as1"..quschen,text)
Redis:set(RunThon.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true2")
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(RunThon.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true2" then
send(msg_chat_id,msg_id, '\n⇜ ارسل الجواب الثالث')
local quschen = Redis:get(RunThon.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(RunThon.."lkz:gamebot:newqus:as2"..quschen,text)
Redis:set(RunThon.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true3")
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(RunThon.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true3" then
send(msg_chat_id,msg_id, ' \n⇜ ارسل الجواب الصحيح')
local quschen = Redis:get(RunThon.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(RunThon.."lkz:gamebot:newqus:as3"..quschen,text)
Redis:set(RunThon.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true44")
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(RunThon.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true44" then
send(msg_chat_id,msg_id, '\n⇜ تم حفظ الجواب الصحيح')
local quschen = Redis:get(RunThon.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(RunThon.."lkz:gamebot:newqus:as4"..quschen,text)
Redis:set(RunThon.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true186")
return false 
end
end
if Redis:get(RunThon..":"..msg.sender_id.user_id..":lov_Bots"..msg.chat_id) == "sendlove" then
...
Redis:del(RunThon..":"..msg.sender_id.user_id..":lov_Bots"..msg.chat_id)
end
if Redis:get(RunThon..":"..msg.sender_id.user_id..":lov_Bottts"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⇜ نسبة الغباء : '..text..' '..sendnum..'%'
send(msg_chat_id,msg_id,tttttt) 
Redis:del(RunThon..":"..msg.sender_id.user_id..":lov_Bottts"..msg.chat_id)
end
if Redis:get(RunThon..":"..msg.sender_id.user_id..":lov_Botttuus"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⇜ نسبة الذكاء : '..text..' '..sendnum..'%'
send(msg_chat_id,msg_id,tttttt) 
Redis:del(RunThon..":"..msg.sender_id.user_id..":lov_Botttuus"..msg.chat_id)
end
if text and Redis:get(RunThon..":"..msg.sender_id.user_id..":krh_Bots"..msg.chat_id) == "sendkrhe" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⇜ نسبه الكره : '..text..' '..sendnum..'%'
send(msg_chat_id,msg_id,tttttt) 
Redis:del(RunThon..":"..msg.sender_id.user_id..":krh_Bots"..msg.chat_id)
end
if text and text ~="نسبه الرجوله" and Redis:get(RunThon..":"..msg.sender_id.user_id..":rjo_Bots"..msg.chat_id) == "sendrjoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","🥰 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '⇜ نسبة الرجوله : '..text..' '..sendnuj..'%'
send(msg_chat_id,msg_id,tttttt) 
Redis:del(RunThon..":"..msg.sender_id.user_id..":rjo_Bots"..msg.chat_id)
end
if text and text ~="نسبه الانوثه" and Redis:get(RunThon..":"..msg.sender_id.user_id..":ano_Bots"..msg.chat_id) == "sendanoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","?? 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '⇜ نسبه الانوثة : '..text..' '..sendnuj..'%'
send(msg_chat_id,msg_id,tttttt) 
Redis:del(RunThon..":"..msg.sender_id.user_id..":ano_Bots"..msg.chat_id)
end
if Redis:get(RunThon.."TheRunThon:Game:Arbieq"..msg.chat_id) then
if text == Redis:get(RunThon.."TheRunThon:Game:Arbieq"..msg.chat_id) then 
Redis:del(RunThon.."TheRunThon:Game:Arbieq"..msg.chat_id)
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
...
---------------------- عقـــاب ----------------------
if Redis:get(RunThon.."Start_Ahkamm"..msg.chat_id) then
if text == "انا" then
if Redis:sismember(RunThon..'List_Ahkamm'..msg.chat_id,msg.sender_id.user_id) then
return bot.sendText(msg.chat_id,msg.id,'⇜ اسمك موجود من قبل',"md",true)
end
Redis:sadd(RunThon..'members_Ahkamm'..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(RunThon..'List_Ahkamm'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(RunThon.."Witting_StartGamehh"..msg.chat_id,1400,true)
...
---------------------- احكـــام ----------------------
if text == "انا" and Redis:get(RunThon.."Start_Ahkkam"..msg.chat_id) then
if Redis:sismember(RunThon..'List_Ahkkam'..msg.chat_id,msg.sender_id.user_id) then
return bot.sendText(msg.chat_id,msg.id,'⇜ اسمك موجود من قبل',"md",true)
end
Redis:sadd(RunThon..'List_Ahkkam'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(RunThon.."Witting_StartGameh"..msg.chat_id,1400,true)
local list = Redis:smembers(RunThon..'List_Ahkkam'..msg.chat_id) 
if #list == 2 then
...
---------------------- كرســـي الاعتـــراف ----------------------
if text == "انا" and Redis:get(RunThon.."Start_Koorsi"..msg.chat_id) then
if Redis:sismember(RunThon..'List_Koorsi'..msg.chat_id,msg.sender_id.user_id) then
return bot.sendText(msg.chat_id,msg.id,'⇜ اسمك موجود من قبل',"md",true)
end
Redis:sadd(RunThon..'List_Koorsi'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(RunThon.."Witting_StartGameek"..msg.chat_id,1400,true)
local list = Redis:smembers(RunThon..'List_Koorsi'..msg.chat_id) 
if #list == 2 then
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '- ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')'
local zzllzz = '⇜ عدد الاعبين : '..#list..' \n⇜ انضم للعبة \n'..Teext
...
if Redis:get(RunThon.."TheRunThon:Game:Arbieq:aslame"..msg.chat_id) then
if text == Redis:get(RunThon.."TheRunThon:Game:Arbieq:aslame"..msg.chat_id) then 
Redis:del(RunThon.."TheRunThon:Game:Arbieq:aslame"..msg.chat_id)
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
end
if Redis:get(RunThon.."TheRunThon:Game:Arbieq:aslamek"..msg.chat_id) then
if text == Redis:get(RunThon.."TheRunThon:Game:Arbieq:aslamek"..msg.chat_id) then 
Redis:del(RunThon.."TheRunThon:Game:Arbieq:aslamek"..msg.chat_id)
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
end
if Redis:get(RunThon.."TheRunThon:Game:Monotonousss"..msg.chat_id) then
if text == Redis:get(RunThon.."TheRunThon:Game:Monotonousss"..msg.chat_id) then 
Redis:del(RunThon.."TheRunThon:Game:Monotonousss"..msg.chat_id)
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
...
if Redis:get(RunThon.."mshaher"..msg.chat_id) then
if text == Redis:get(RunThon.."mshaher"..msg.chat_id) then
Redis:del(RunThon.."mshaher"..msg.chat_id)
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true)  
end
end 
if Redis:get(RunThon.."mshaherr"..msg.chat_id) then
if text == Redis:get(RunThon.."mshaherr"..msg.chat_id) then
Redis:del(RunThon.."mshaherr"..msg.chat_id)
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true)  
end
end
if Redis:get(RunThon.."mshaherrr"..msg.chat_id) then
if text == Redis:get(RunThon.."mshaherrr"..msg.chat_id) then
Redis:del(RunThon.."mshaherrr"..msg.chat_id)
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true)  
end
end  
if Redis:get(RunThon.."photohzr"..msg.chat_id) then
if text == Redis:get(RunThon.."photohzr"..msg.chat_id) then
Redis:del(RunThon.."photohzr"..msg.chat_id)
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true)  
end
...
if Redis:get(RunThon.."Start_rhan"..msg.chat_id) then
if text and text:match('^انا (.*)$') then
local UserName = text:match('^انا (.*)$')
local coniss = coin(UserName)
ballancee = Redis:get(RunThon.."boob"..msg.sender_id.user_id) or 0
...
if Redis:sismember(RunThon..'List_rhan'..msg.chat_id,msg.sender_id.user_id) then
return send(msg.chat_id,msg.id,'⇜ انت مضاف من قبل .',"md",true)
end
Redis:set(RunThon.."playerrhan"..msg.chat_id,msg.sender_id.user_id)
Redis:set(RunThon.."playercoins"..msg.chat_id..msg.sender_id.user_id,coniss)
Redis:sadd(RunThon..'List_rhan'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(RunThon.."Witting_Startrhan"..msg.chat_id,1400,true)
benrahan = Redis:get(RunThon.."allrhan"..msg.chat_id..12345) or 0
rehan = tonumber(benrahan) + tonumber(coniss)
Redis:set(RunThon.."allrhan"..msg.chat_id..12345 , rehan)
local ballancee = Redis:get(RunThon.."boob"..msg.sender_id.user_id) or 0
rehan = tonumber(ballancee) - tonumber(coniss)
Redis:set(RunThon.."boob"..msg.sender_id.user_id , rehan)
...
if text == "حظي" then
if Redis:get(RunThon.."TheRunThon:Status:Games:malk"..msg.chat_id) then
return false 
end
if not Redis:get(RunThon.."TheRunThon:Status:Games"..msg.chat_id) then
return false
end
local list = {"3","5","-3","-5","="}
RtList = list[math.random(#list)]
if RtList == "3" then
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id,3)
StatusRt = "الف مبروك حظك حلو ربحت 3 نقاط"
elseif RtList == "5" then
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id,5)
StatusRt = "الف مبروك حظك حلو ربحت 5 نقاط"
elseif RtList == "-3" then
Redis:decrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id,3)  
StatusRt = "للاسف حظك زفت خسرت 3 نقاط"
elseif RtList == "-5" then
Redis:decrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id,5)  
...
Redis:set(RunThon.."TheRunThon:Game:Arbieq"..msg.chat_id,name)
return false
end
...
Redis:set(RunThon.."TheRunThon:Game:Arbieq:aslame"..msg.chat_id,name)
return false
end
if text == "اية" then
if Redis:get(RunThon.."TheRunThon:Status:Games:malk"..msg.chat_id) then
...
Redis:set(RunThon.."TheRunThon:Game:Arbieq:aslamek"..msg.chat_id,name)
return false
end
...
Redis:set(RunThon.."TheRunThon:Game:Monotonousss"..msg.chat_id,name)
return false
end
if text == "حجره" then
if Redis:get(RunThon.."TheRunThon:Status:Games:malk"..msg.chat_id) then
...
local Bot_Name = (Redis:get(RunThon.."TheRunThon:Name:Bot") or "رنثون")
if not Redis:get(RunThon.."TheRunThon:Status:repleall") then
if text == 'صباح الخير' or text == 'صباحو' or text =='صباح النور' then
if Redis:get(RunThon.."replayallbot"..msg.chat_id) then
local NamecBots = {
'صباح الياسمين',
'صباح النور',
...
if text== "الابراج"  or text== "ابراج"  and Redis:get(RunThon..'replayallbot'..msg.chat_id) then
return send(msg.chat_id,msg.id,"ٰ⇜ اكتب : برج + اسم برجك ")
end
if text== "همسه"  or text== "همسة"  and Redis:get(RunThon..'replayallbot'..msg.chat_id) then
return send(msg.chat_id,msg.id,"⇜ اهلا بك عزيزي\n⇜ اكتب معرف البوت ثم الرساله ثم معرف الشخص\n⇜ مثال\n[@rigbot] مرحبا [@DevZaid]")
end
if text== "تحويل الصيغ" and Redis:get(RunThon..'replayallbot'..msg.chat_id) then
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(RunThon..'TheRunThon:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(RunThon..'TheRunThon:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
if ChannelJoin(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(RunThon..'TheRunThon:Channel:Join:Name'), url = 't.me/'..Redis:get(RunThon..'TheRunThon:Channel:Join')}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
if not msg.DevelopersQ then 
return send(msg_chat_id,msg_id,'\n⇜ هذا الامر يخص ( '..Controller_Num(2)..' ) ',"md",true)  
end
Redis:set(RunThon.."gamebot:Set:Manager:rd"..msg.sender_id.user_id..":"..msg.chat_id,true)
...
Redis:set(RunThon.."gamebot:Set:Manager:rdd"..msg.sender_id.user_id..":"..msg.chat_id,true)
...
if Redis:get(RunThon.."TheRunThon:Status:Games"..msg.chat_id) then 
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(RunThon..'TheRunThon:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(RunThon..'TheRunThon:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local list = Redis:smembers(RunThon.."gamebot:List:Manager")
if #list ~= 0 then
...
for k,v in pairs(list) do
Redis:sadd(RunThon.."gamebot:List:Manager",v)
end
...
Redis:sadd(RunThon.."Black:listBan:",Chatid)
...
Redis:srem(RunThon.."Black:listBan:",Chatid)
...
Redis:del(RunThon..'rolet:list'..msg.chat_id) 
...
Redis:del(RunThon..'loce:list'..msg.chat_id) 
send(msg_chat_id,msg_id,xxffxx,"md",false, false, false, false, reply_markup)
end
end
...
Redis:set(RunThon.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,true)
...
Redis:set(RunThon.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,'truedel')
return send(msg_chat_id,msg_id,"⇜ ارسل السؤال الان ")
end
...
local list = Redis:smembers(RunThon.."gamebot:new1")
...
Redis:del(RunThon.."gamebot:new1")
...
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(RunThon.."TheRunThon:Game:alam"..msg.chat_id,name)
...
Redis:set(RunThon.."TheRunThon:Game:ausm"..msg.chat_id,name)
return false
end
end
if Redis:get(RunThon.."TheRunThon:Game:klmaa"..msg.chat_id) then
if text == Redis:get(RunThon.."TheRunThon:Game:klmaa"..msg.chat_id) then
Redis:del(RunThon.."TheRunThon:Game:klmaa"..msg.chat_id)
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
...
Redis:set(RunThon.."TheRunThon:Game:klmaa"..msg.chat_id,name)
return false
end
end
...
Redis:del(RunThon..'List_Ahkamm'..msg.chat_id)
Redis:del(RunThon..'members_Ahkamm'..msg.chat_id) 
Redis:set(RunThon.."raeahkamm"..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(RunThon..'List_Ahkamm'..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(RunThon..'members_Ahkamm'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(RunThon.."Start_Ahkamm"..msg.chat_id,3600,true)
...
local list = Redis:smembers(RunThon..'List_Ahkamm'..msg.chat_id) 
...
if text == 'نعم' and Redis:get(RunThon.."Witting_StartGamehh"..msg.chat_id) then
rarahkam = Redis:get(RunThon.."raeahkamm"..msg.chat_id)
...
Redis:sadd(RunThon.."kk_Akab"..msg.chat_id,UserId_Info.id)
Redis:srem(RunThon..'members_Ahkamm'..msg_chat_id,UserId_Info.id) 
local GetLike = Redis:incrby(RunThon.."Num:Add:Akab"..msg.chat_id..UserId_Info.id, 1) 
Redis:hset(RunThon..':GroupUserCountAkab:'..msg.chat_id,UserId_Info.id,GetLike)
...
NameLUser = NameLUser:gsub("[[]","")
Redis:hset(RunThon..':GroupAkabNameUser:'..msg.chat_id,UserId_Info.id,NameLUser)
Redis:del(RunThon..'raeahkamm'..msg.chat_id) 
Redis:del(RunThon..'List_Ahkamm'..msg.chat_id) 
Redis:del(RunThon.."Witting_StartGamehh"..msg.chat_id)
Redis:del(RunThon.."Start_Ahkamm"..msg.chat_id)
katu = {
...
Redis:del(RunThon..'List_Ahkkam'..msg.chat_id)
Redis:set(RunThon.."raeahkkam"..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(RunThon..'List_Ahkkam'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(RunThon.."Start_Ahkkam"..msg.chat_id,3600,true)
...
local Quuiz = Redis:get(RunThon.."Quiz:Add:Koorsy"..msg.chat_id) or 0
...
Redis:del(RunThon..'List_Koorsi'..msg.chat_id)
Redis:del(RunThon.."Quiz:Add:Koorsy"..msg.chat_id)
Redis:set(RunThon.."raekoorsi"..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(RunThon..'List_Koorsi'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(RunThon.."Start_Koorsi"..msg.chat_id,3600,true)
bot.sendText(msg_chat_id,msg_id,zzllzz,"md",false, false, false, false, reply_markup)
end
----------------------------------------
...
local Qiuiz = Redis:get(RunThon.."Quiz:Add:Saraha"..msg.chat_id) or 0
...
Redis:del(RunThon..'List_Saraha'..msg.chat_id)
Redis:del(RunThon.."Quiz:Add:Saraha"..msg.chat_id)
Redis:set(RunThon.."raesaraha"..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(RunThon..'List_Saraha'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(RunThon.."Start_Saraha"..msg.chat_id,3600,true)
bot.sendText(msg_chat_id,msg_id,zzllzz,"md",false, false, false, false, reply_markup)
end
----------------------------------
...
if not Redis:get(RunThon.."Status:Aktmooh"..msg.chat_id) then
...
Redis:set(RunThon.."Ak_Tmooh"..msg.chat_id,Message_Reply.sender_id.user_id)
Redis:del(RunThon..'List_Aktooh'..msg.chat_id)
Redis:set(RunThon.."raeaktooh"..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(RunThon..'List_Aktooh'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(RunThon.."Start_Aktmooh"..msg.chat_id,3600,true)
bot.sendText(msg_chat_id,msg_id,zzllzz,"md",false, false, false, false, reply_markup)
end
...
Redis:set(RunThon.."makal:bots:set"..msg.sender_id.user_id..":"..msg.chat_id,true)
return send(msg_chat_id,msg_id,"⇜ ارسل السؤال الان ")
end
...
Redis:set(RunThon.."makal:bots:del"..msg.sender_id.user_id..":"..msg.chat_id,true)
...
Redis:del(RunThon.."makal:bots")
return send(msg_chat_id,msg_id,"⇜ تم مسح الجمل")
end
if text and text:match("^(.*)$") then
if Redis:get(RunThon.."makal:bots:del"..msg.sender_id.user_id..":"..msg.chat_id) == "true" then
Redis:set(RunThon.."makal:bots:del"..msg.sender_id.user_id..":"..msg.chat_id,"true1uu")
Redis:srem(RunThon.."makal:bots", text)
return send(msg_chat_id,msg_id, '\n⇜ تم مسح السؤال')
end
end
if text and text:match("^(.*)$") then
if Redis:get(RunThon.."makal:bots:set"..msg.sender_id.user_id..":"..msg.chat_id) == "true" then
Redis:set(RunThon.."makal:bots:set"..msg.sender_id.user_id..":"..msg.chat_id,"true1uu")
Redis:sadd(RunThon.."makal:bots", text)
return send(msg_chat_id,msg_id, '\n⇜ تم حفظ السؤال ')
end
end
if text == 'جمل' then
...
Redis:set(RunThon.."makal:bots:qus"..msg.chat_id,quschen1)
Redis:setex(RunThon.."mkal:setex:" .. msg.chat_id .. ":" .. msg.sender_id.user_id, 60, true) 
end
end
end
if text == ""..(Redis:get(RunThon.."makal:bots:qus"..msg.chat_id) or '').."" then
local timemkall = Redis:ttl(RunThon.."mkal:setex:" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
...
Redis:del(RunThon.."makal:bots:qus"..msg.sender_id.user_id..":"..msg.chat_id)
Redis:del(RunThon.."mkal:setex:" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
end
if text =="صراحه" then
if Redis:get(RunThon.."TheRunThon:Status:Games:malk"..msg.chat_id) then
return false 
...
if not Redis:get(RunThon..'lock_geams'..msg.chat_id) then
local list = Redis:smembers(RunThon.."gamebot:new1")
if #list ~= 0 then
local quschen = list[math.random(#list)]
local ansar1 = Redis:get(RunThon.."gamebot:newqus:as1"..quschen)
local ansar2 = Redis:get(RunThon.."gamebot:newqus:as2"..quschen)
local ansar3 = Redis:get(RunThon.."gamebot:newqus:as3"..quschen)
local ansar0 = Redis:get(RunThon.."gamebot:newqus:as0"..quschen)
local ansar4 = Redis:get(RunThon.."gamebot:newqus:as4"..quschen)
...
Redis:set(RunThon.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,true)
...
Redis:set(RunThon.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,'truedel')
return send(msg_chat_id,msg_id,"⇜ ارسل اللغز الان ")
end
...
local list = Redis:smembers(RunThon.."lkz:gamebot:new1")
t = "⇜ الالغاز : \n"
for k,v in pairs(list) do
t = t..""..k.."- "..v.."\n"
end
...
Redis:del(RunThon.."lkz:gamebot:new1")
...
if #list ~= 0 then
local quschen = list[math.random(#list)]
local ansar1 = Redis:get(RunThon.."lkz:gamebot:newqus:as1"..quschen)
local ansar2 = Redis:get(RunThon.."lkz:gamebot:newqus:as2"..quschen)
local ansar3 = Redis:get(RunThon.."lkz:gamebot:newqus:as3"..quschen)
local ansar4 = Redis:get(RunThon.."lkz:gamebot:newqus:as4"..quschen)
if ansar1 == ansar4 then
tt = 'ansar1'
elseif ansar2 == ansar4 then
tt = 'ansar2'
...
Redis:del(RunThon.."gamebot:List:Manager")
...
local numtsh = Redis:scard(RunThon..'TheRunThon:tahaath'..msg.chat_id)
if numtsh ==0 then  
return send(msg_chat_id,msg_id, "⇜ مافي كيكات" )
end
Redis:del(RunThon..'TheRunThon:tahaath'..msg.chat_id)
...
local numtsh = Redis:scard(RunThon..'TheRunThon:klp'..msg.chat_id)
if numtsh ==0 then  
return send(msg_chat_id,msg_id, "⇜ مافي عسلات" )
end
Redis:del(RunThon..'TheRunThon:klp'..msg.chat_id)
...
local numtsh = Redis:scard(RunThon..'TheRunThon:donke'..msg.chat_id)
if numtsh ==0 then  
return send(msg_chat_id,msg_id, "⇜ مافي زقات" )
end
Redis:del(RunThon..'TheRunThon:donke'..msg.chat_id)
...
local numtsh = Redis:scard(RunThon..'TheRunThon:zahf'..msg.chat_id)
if numtsh ==0 then  
return send(msg_chat_id,msg_id, "⇜ مافي حمير" )
end
Redis:del(RunThon..'TheRunThon:zahf'..msg.chat_id)
...
local numtsh = Redis:scard(RunThon..'TheRunThon:sakl'..msg.chat_id)
if numtsh ==0 then  
return send(msg_chat_id,msg_id, "⇜ مافي بقر" )
end
Redis:del(RunThon..'TheRunThon:sakl'..msg.chat_id)
...
local numtsh = Redis:scard(RunThon..'TheRunThon:klpe'..msg.chat_id)
if numtsh ==0 then  
return send(msg_chat_id,msg_id, "⇜ مافي احد بقلبك" )
end
Redis:del(RunThon..'TheRunThon:klpe'..msg.chat_id)
...
local numtsh = Redis:scard(RunThon..'TheRunThon:tagge'..msg.chat_id)
if numtsh ==0 then  
return send(msg_chat_id,msg_id, "⇜ مافي كلاب" )
end
Redis:del(RunThon..'TheRunThon:tagge'..msg.chat_id)
...
local numtsh = Redis:scard(RunThon..'TheRunThon:mrtee'..msg.chat_id)
if numtsh ==0 then  
return send(msg_chat_id,msg_id, "⇜ مافي هطوف" )
end
Redis:del(RunThon..'TheRunThon:mrtee'..msg.chat_id)
...
local numtsh = Redis:scard(RunThon..'TheRunThon:loke'..msg.chat_id)
if numtsh ==0 then  
return send(msg_chat_id,msg_id, "⇜ مافي قرود" )
end
Redis:del(RunThon..'TheRunThon:loke'..msg.chat_id)
...
local numtsh = Redis:scard(RunThon..'TheRunThon:stope'..msg.chat_id)
if numtsh ==0 then  
return send(msg_chat_id,msg_id, "⇜ مافي خرفان" )
end
Redis:del(RunThon..'TheRunThon:stope'..msg.chat_id)
...
if not Redis:get(RunThon.."trfeh"..msg.chat_id) then    
Redis:set(RunThon..":"..msg.sender_id.user_id..":lov_Bots"..msg.chat_id,"sendlove")
...
if not Redis:get(RunThon.."trfeh"..msg.chat_id) then    
Redis:set(RunThon..":"..msg.sender_id.user_id..":lov_Bottts"..msg.chat_id,"sendlove")
...
if not Redis:get(RunThon.."trfeh"..msg.chat_id) then    
Redis:set(RunThon..":"..msg.sender_id.user_id..":lov_Botttuus"..msg.chat_id,"sendlove")
hggg = '⇜ الان ارسل اسم الشخص '
send(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(RunThon.."trfeh"..msg.chat_id) then    
Redis:set(RunThon..":"..msg.sender_id.user_id..":krh_Bots"..msg.chat_id,"sendkrhe")
hggg = '⇜ الان ارسل اسمك واسم الشخص الثاني '
send(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(RunThon.."trfeh"..msg.chat_id) then    
Redis:set(RunThon..":"..msg.sender_id.user_id..":rjo_Bots"..msg.chat_id,"sendrjoe")
hggg = '⇜ الان ارسل اسم الشخص '
send(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(RunThon.."trfeh"..msg.chat_id) then    
Redis:set(RunThon..":"..msg.sender_id.user_id..":ano_Bots"..msg.chat_id,"sendanoe")
hggg = '⇜ الان ارسل اسم الشخص '
send(msg_chat_id,msg_id,hggg) 
return false
end
end
if text== "رفع كيكه" and msg.reply_to_message_id and not Redis:get(RunThon.."trfeh"..msg.chat_id) then
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(RunThon..'TheRunThon:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(RunThon..'TheRunThon:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(RunThon.."TheRunThon:tahaath"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته كيكه 🍰\n✧️")
elseif text== "تنزيل كيكه" and msg.reply_to_message_id and not Redis:get(RunThon.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(RunThon..'TheRunThon:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(RunThon..'TheRunThon:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(RunThon.."TheRunThon:tahaath"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر نزلته من كيكه\n✧")
elseif text== "رفع عسل" and msg.reply_to_message_id and not Redis:get(RunThon.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(RunThon..'TheRunThon:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(RunThon..'TheRunThon:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(RunThon.."TheRunThon:klp"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته عسل 🍯\n✧")
elseif text== "رفع زق"  and msg.reply_to_message_id and not Redis:get(RunThon.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(RunThon..'TheRunThon:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(RunThon..'TheRunThon:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(RunThon.."TheRunThon:donke"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته زق 💩\n✧️")
elseif text== "تنزيل زق"  and msg.reply_to_message_id and not Redis:get(RunThon.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(RunThon..'TheRunThon:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(RunThon..'TheRunThon:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(RunThon.."TheRunThon:donke"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر نزلته من زق\n✧️")
elseif text== "تنزيل عسل"  and msg.reply_to_message_id and not Redis:get(RunThon.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(RunThon..'TheRunThon:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(RunThon..'TheRunThon:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(RunThon.."TheRunThon:klp"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر نزلته من عسل\n✧️")
elseif text== "تنزيل حمار"  and msg.reply_to_message_id and not Redis:get(RunThon.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(RunThon..'TheRunThon:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(RunThon..'TheRunThon:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(RunThon.."TheRunThon:zahf"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته حمار\n✧️")
elseif text== "رفع حمار"  and msg.reply_to_message_id and not Redis:get(RunThon.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(RunThon..'TheRunThon:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(RunThon..'TheRunThon:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(RunThon.."TheRunThon:zahf"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته حمار 🦓\n✧️")
elseif text== "رفع بقره" or text== "رفع بقرة" and msg.reply_to_message_id and not Redis:get(RunThon.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(RunThon..'TheRunThon:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(RunThon..'TheRunThon:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(RunThon.."TheRunThon:sakl"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته بقره 🐄\n✧")
elseif text== "تنزيل بقره" or text== "تنزيل بقرة" and msg.reply_to_message_id and not Redis:get(RunThon.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(RunThon..'TheRunThon:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(RunThon..'TheRunThon:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(RunThon.."TheRunThon:sakl"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر نزلته من بقرة\n✧️")
elseif text== "رفع بقلبي" or text== "رفع لقلبي" and msg.reply_to_message_id and not Redis:get(RunThon.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(RunThon..'TheRunThon:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(RunThon..'TheRunThon:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(RunThon.."TheRunThon:klpe"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته لقلبك ❤️\n✧️")
elseif text== "تنزيل من قلبي"  and msg.reply_to_message_id and not Redis:get(RunThon.."trfeh"..msg.chat_id) then  
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(RunThon..'TheRunThon:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(RunThon..'TheRunThon:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(RunThon.."TheRunThon:klpe"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر نزلته من قلبك\n✧")
elseif text== "رفع كلب"  and msg.reply_to_message_id and not Redis:get(RunThon.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(RunThon..'TheRunThon:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(RunThon..'TheRunThon:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(RunThon.."TheRunThon:tagge"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته كلب 🐩️ \n✧️")
elseif text== "تنزيل كلب"  and msg.reply_to_message_id and not Redis:get(RunThon.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(RunThon..'TheRunThon:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(RunThon..'TheRunThon:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(RunThon.."TheRunThon:tagge"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر نزلته من كلب\n✧")
elseif text== "رفع هطف" and msg.reply_to_message_id and not Redis:get(RunThon.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(RunThon..'TheRunThon:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(RunThon..'TheRunThon:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(RunThon.."TheRunThon:mrtee"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته هطف 🧱\n✧")
elseif text== "تنزيل هطف"  and msg.reply_to_message_id and not Redis:get(RunThon.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(RunThon..'TheRunThon:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(RunThon..'TheRunThon:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(RunThon.."TheRunThon:mrtee"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر نزلته من هطف\n✧")
elseif text== "رفع قرد" and msg.reply_to_message_id and not Redis:get(RunThon.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(RunThon..'TheRunThon:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(RunThon..'TheRunThon:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(RunThon.."TheRunThon:loke"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته قرد 🐒\n✧️")
elseif text== "تنزيل قرد" and msg.reply_to_message_id and not Redis:get(RunThon.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(RunThon..'TheRunThon:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(RunThon..'TheRunThon:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(RunThon.."TheRunThon:loke"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر نزلته من قرد\n✧")
elseif text== "رفع خروف" and msg.reply_to_message_id and not Redis:get(RunThon.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(RunThon..'TheRunThon:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(RunThon..'TheRunThon:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(RunThon.."TheRunThon:stope"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته خاروف 🐏\n✧️")
elseif text== "تنزيل خاروف" and msg.reply_to_message_id and not Redis:get(RunThon.."trfeh"..msg.chat_id) then  
  if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(RunThon..'TheRunThon:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(RunThon..'TheRunThon:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(RunThon.."TheRunThon:stope"..msg.chat_id, Message_Reply.sender_id.user_id)
...
local list = Redis:smembers(RunThon.."TheRunThon:tahaath"..msg.chat_id)
...
local list = Redis:smembers(RunThon.."TheRunThon:klp"..msg.chat_id)
...
local list = Redis:smembers(RunThon.."TheRunThon:donke"..msg.chat_id)
...
local list = Redis:smembers(RunThon.."TheRunThon:zahf"..msg.chat_id)
...
local list = Redis:smembers(RunThon.."TheRunThon:sakl"..msg.chat_id)
...
local list = Redis:smembers(RunThon.."TheRunThon:klpe"..msg.chat_id)
...
local list = Redis:smembers(RunThon.."TheRunThon:tagge"..msg.chat_id)
...
local list = Redis:smembers(RunThon.."TheRunThon:mrtee"..msg.chat_id)
...
local list = Redis:smembers(RunThon.."TheRunThon:loke"..msg.chat_id)
...
local list = Redis:smembers(RunThon.."TheRunThon:stope"..msg.chat_id)
...
if not Redis:get(RunThon.."TheRunThon:Alzwag:Chat"..msg_chat_id) then
...
if tonumber(member_id) == tonumber(msg.sender_id.user_id) or tonumber(member_id) == tonumber(RunThon) or bot.getUser(member_id).type.luatele == "userTypeBot" or Redis:get(RunThon..msg_chat_id..member_id.."mtzwga:") then 
return send(msg_chat_id,msg_id,"⇜ اسف ياحلو مو وقت زواج الحين","md")
end
if Redis:get(RunThon..msg_chat_id..msg.sender_id.user_id.."mtzwga:") then
    local zwg_id =  Redis:get(RunThon..msg_chat_id..msg.sender_id.user_id.."mtzwga:")
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if tonumber(Redis:get(RunThon..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:")) == tonumber(msg.sender_id.user_id) or tonumber(Redis:get(RunThon..msg_chat_id..msg.sender_id.user_id.."mtzwga:")) == tonumber(Message_Reply.sender_id.user_id) then
...
elseif tonumber(Message_Reply.sender_id.user_id) == tonumber(RunThon) then
  return send(msg_chat_id,msg_id,"⇜ هييه مايمديك تتزوجني\n✧","md")
elseif Redis:get(RunThon..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:") then
local zwg_id =  Redis:get(RunThon..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:")
local zwg_info = bot.getUser(zwg_id)
return send(msg_chat_id,msg_id,"⇜ وينك ياوحش\n["..zwg_info.first_name.."](tg://user?id="..zwg_id..")\n⇜ يبون يتزوجو زوجتك ","md")
elseif Redis:get(RunThon..msg_chat_id..msg.sender_id.user_id.."mtzwga:") then
  local zwg_id =  Redis:get(RunThon..msg_chat_id..msg.sender_id.user_id.."mtzwga:")
  local zwg_info = bot.getUser(zwg_id)
  return send(msg_chat_id,msg_id,"⇜ الحين اناديها انتظر\n["..zwg_info.first_name.."](tg://user?id="..zwg_id..")\n⇜ يبي يتزوج عليك هههه","md")
elseif not Redis:get(RunThon..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:")  then
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if text == "زوجتي" then
  if Redis:get(RunThon..msg_chat_id..msg.sender_id.user_id.."mtzwga:") then
    local zwga_id = Redis:get(RunThon..msg_chat_id..msg.sender_id.user_id.."mtzwga:")
  ...
  elseif not Redis:get(RunThon..msg_chat_id..msg.sender_id.user_id.."mtzwga:") then
...
elseif tonumber(Redis:get(RunThon..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:")) ~= tonumber(msg.sender_id.user_id) or tonumber(Redis:get(RunThon..msg_chat_id..msg.sender_id.user_id.."mtzwga:")) ~= tonumber(Message_Reply.sender_id.user_id) then
  return send(msg_chat_id,msg_id,"⇜ هييه مايمديك تطلقها لان مو زوجتك\n✧","md")
elseif tonumber(Redis:get(RunThon..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:")) == tonumber(msg.sender_id.user_id) or tonumber(Redis:get(RunThon..msg_chat_id..msg.sender_id.user_id.."mtzwga:")) == tonumber(Message_Reply.sender_id.user_id) then
    Redis:del(RunThon..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:")
    Redis:del(RunThon..msg_chat_id..msg.sender_id.user_id.."mtzwga:")
...
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(RunThon.."mshaher"..msg.chat_id,name)
...
Redis:set(RunThon.."mshaherr"..msg.chat_id,name)
...
Redis:set(RunThon.."mshaherrr"..msg.chat_id,name)
...
KlamSpeeddd = {"ديل","زيتون","بن تن","ون بيس","نمله","توت","دكتور","باونتي","عسل","سابق ولاحق","دماغ","خروف","ميكي ماوس","كرسي","كيا","عين","بي ام دبليو","بشت","لاما","ببجي","سيمبا","سبونج بوب","شاي","طبله","كابتن ماجد","اليابان","بزر","ديك رومي","لاكوست","نوكيا","بطه","غوريلا","باب","كراش","لوتس","فرشه","اسعاف","تركيا","تشيلسي","طرزان","ال جي","نوتيلا","طفايه","عدنان ولينا","فتيات القوه","دمعه","قراند","قطط","سله","فلاش","يد","كبد","الصين","مكسرات","فيمتو","باباي","كارنثون","مسجد","برايه","بطوط","باندا","كيندر","طياره","سنافر","الصين","سالي","بطريق","قرد","شاورما","ثريه","ميداليه","ماعز","سرير","هدى","بطاريه","احلام","نيسان","لابتوب","نسر","مسدس","مسواك","بير","قوقل","ملعب","دبابه","مغسله","سلم","دبور","كودو","بيانو","كهف","مشط","نقار الخشب","تفاح","طاوله","عنكبوت"};
name = KlamSpeeddd[math.random(#KlamSpeeddd)]
Redis:set(RunThon.."photohzr"..msg.chat_id,name)
...
Redis:setex(RunThon.."Status:aktbassend"..msg.chat_id,120,true) 
return send(msg_chat_id,msg_id,'\n⇜ ارسل لي الاقتباس\n- يسمح لك :\n( ملصق + صورة + نص + فيديو + صوت )',"md",true)  
end
if Redis:get(RunThon..'Status:aktbassend'..msg.chat_id) then
Redis:del(RunThon..'Status:aktbassend'..msg.chat_id)
Redis:del(RunThon..'Status:aktbasrdstic'..msg.chat_id)
Redis:del(RunThon..'Status:aktbasrdtext'..msg.chat_id)
Redis:del(RunThon..'Status:aktbasrdaudio'..msg.chat_id)
Redis:del(RunThon..'Status:aktbasrdanim'..msg.chat_id)
Redis:del(RunThon..'Status:aktbasrdvid'..msg.chat_id)
Redis:del(RunThon..'Status:aktbasrdphoto'..msg.chat_id)
if msg.content.sticker then   
Redis:set(RunThon.."Status:aktbasrdstic"..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(RunThon.."Status:aktbasrdtext"..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(RunThon.."Status:aktbasrdaudio"..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.animation then
Redis:set(RunThon.."Status:aktbasrdanim"..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video then
Redis:set(RunThon.."Status:aktbasrdvid"..msg_chat_id, msg.content.video.video.remote.id)  
end
...
Redis:set(RunThon.."Status:aktbasrdphoto"..msg_chat_id, idPhoto)  
end
...
Redis:del(RunThon..'Status:Reply'..msg.chat_id)
Redis:set(RunThon.."Status:aktbas"..msg.chat_id,true) 
...
Redis:set(RunThon..'Status:Reply'..msg.chat_id,true)
Redis:del(RunThon.."Status:aktbas"..msg.chat_id) 
send(msg.chat_id,msg.id,"⇜ ابشر عطلت الاقتباسات ","md",true)
end

if Redis:get(RunThon..'Status:aktbas'..msg.chat_id) == 'true' then
...
if Redis:get(RunThon..'Status:aktbasrdstic'..msg.chat_id) then
return bot.sendSticker(msg.chat_id, 0, Redis:get(RunThon..'Status:aktbasrdstic'..msg.chat_id))
elseif Redis:get(RunThon..'Status:aktbasrdtext'..msg.chat_id) then
return send(msg.chat_id,0,Redis:get(RunThon..'Status:aktbasrdtext'..msg.chat_id),"md",true)
elseif Redis:get(RunThon..'Status:aktbasrdaudio'..msg.chat_id) then
return bot.sendAudio(msg.chat_id, 0, Redis:get(RunThon..'Status:aktbasrdaudio'..msg.chat_id), '', "md") 
elseif Redis:get(RunThon..'Status:aktbasrdanim'..msg.chat_id) then
return bot.sendAnimation(msg.chat_id,0, Redis:get(RunThon..'Status:aktbasrdanim'..msg.chat_id), '', 'md')
elseif Redis:get(RunThon..'Status:aktbasrdphoto'..msg.chat_id) then
return bot.sendPhoto(msg.chat_id, 0, Redis:get(RunThon..'Status:aktbasrdphoto'..msg.chat_id),'')
elseif Redis:get(RunThon..'Status:aktbasrdvid'..msg.chat_id) then
return bot.sendVideo(msg.chat_id, 0, Redis:get(RunThon..'Status:aktbasrdvid'..msg.chat_id), '', "md")
else
...
Redis:set(RunThon.."TheRunThon:Game:Smile"..msg.chat_id,SM)
...
KlamSpeed = {"سحور","سياره","استقبال","قنفه","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","كهوه","سفينه","العراق","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","بتيته","لهانه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنيت","ساحه","جسر"};
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(RunThon.."TheRunThon:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(RunThon.."TheRunThon:Game:Riddles"..msg.chat_id,name)
...
if Redis:get(RunThon.."TheRunThon:Status:Games"..msg.chat_id) then
Redis:del(RunThon.."TheRunThon:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(RunThon.."TheRunThon:Game:Meaningof"..msg.chat_id,name)
...
if Redis:get(RunThon.."TheRunThon:Status:Games"..msg.chat_id) then
Redis:del(RunThon.."TheRunThon:Set:Aks"..msg.chat_id)
...
name = katu[math.random(#katu)]
Redis:set(RunThon.."TheRunThon:Game:Reflection"..msg.chat_id,name)
...
Redis:set(RunThon.."TheRunThon:Game:Estimate"..msg.chat_id..msg.sender_id.user_id,Num)  
...
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'النيل') 
elseif SENDTEXT:find('14') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'14') 
elseif SENDTEXT:find('الفم') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'الفم') 
elseif SENDTEXT:find('11') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'11') 
elseif SENDTEXT:find('30') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'30') 
elseif SENDTEXT:find('بوتين') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'بوتين') 
elseif SENDTEXT:find('ستيف جوبر') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'ستيف جوبر') 
elseif SENDTEXT:find('باريس') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'باريس') 
elseif SENDTEXT:find('10') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'10') 
elseif SENDTEXT:find('النمل') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'النمل') 
elseif SENDTEXT:find('حرف الواو') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'حرف الواو') 
elseif SENDTEXT:find('الشعر') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'الشعر') 
elseif SENDTEXT:find('ابراهيم') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'ابراهيم') 
elseif SENDTEXT:find('سحاب') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'سحاب') 
elseif SENDTEXT:find('الاسم') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'الاسم') 
elseif SENDTEXT:find('ذهب') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'ذهب') 
elseif SENDTEXT:find('حرف الام') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'حرف الام') 
elseif SENDTEXT:find('العزائم') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'العزائم') 
elseif SENDTEXT:find('انسات') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'انسات') 
elseif SENDTEXT:find('المنجنيق') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'المنجنيق') 
elseif SENDTEXT:find('اسيا') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'اسيا') 
elseif SENDTEXT:find('الاسد') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'الاسد') 
elseif SENDTEXT:find('6') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'6') 
elseif SENDTEXT:find('مهر') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'مهر') 
elseif SENDTEXT:find('الدلفين') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'الدلفين') 
elseif SENDTEXT:find('اوروبا') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'اوروبا') 
elseif SENDTEXT:find('الزئبق') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'الزئبق') 
elseif SENDTEXT:find('لندن') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'لندن') 
elseif SENDTEXT:find('الانسان') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'الانسان') 
elseif SENDTEXT:find('طوكيو') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'طوكيو') 
elseif SENDTEXT:find('خديجه') then
Redis:set(RunThon.."GAME:CHER"..msg.chat_id,'خديجه') 
end
send(msg.chat_id,msg.id,SENDTEXT)
return false  
end
end
if Redis:get(RunThon.."GAME:CHER"..msg.chat_id) and (text == Redis:get(RunThon.."GAME:CHER"..msg.chat_id)) then  
if text then
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)
Redis:del(RunThon.."GAME:CHER"..msg.chat_id)
local Num = Redis:get(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true)
...
print(name)
Redis:set(RunThon..'bot:bkbk6'..msg.chat_id,name)
...
Redis:set(RunThon..'bot:bkbk7'..msg.chat_id,name)
...
if Redis:get(RunThon.."TheRunThon:Status:Games"..msg.chat_id) then
Redis:del(RunThon..":Number_Add:"..msg.chat_id..msg.sender_id.user_id) 
Redis:del(RunThon..':List_Rolet:'..msg.chat_id)  
Redis:setex(RunThon..":Start_Rolet:"..msg.chat_id..msg.sender_id.user_id,3600,true)  
return send(msg_chat_id,msg_id, '⇜ حسناً لنلعب , ارسل عدد اللاعبين للروليت .',"md")
end
end
if text == 'نعم' and Redis:get(RunThon..":Witting_StartGame:"..msg.chat_id..msg.sender_id.user_id) then
local list = Redis:smembers(RunThon..':List_Rolet:'..msg.chat_id) 
if #list == 1 then 
...
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 5)  
Redis:del(RunThon..':List_Rolet:'..msg.chat_id) 
Redis:del(RunThon..":Witting_StartGame:"..msg.chat_id..msg.sender_id.user_id)
...
if text and text:match("^(%d+)$") and Redis:get(RunThon..":Start_Rolet:"..msg.chat_id..msg.sender_id.user_id) then
if text == "1" then
Text = "⇜ لا استطيع بدء اللعبة بلاعب واحد فقط\n"
else
Redis:set(RunThon..":Number_Add:"..msg.chat_id..msg.sender_id.user_id,text)  
Text = '⇜ يرجى ارسال يوزرات اللاعبين \n⇜ الفائز يحصل على ( 5 ) نقاط\n⇜ عدد الاعبين المطلوبين ( '..text..' ) لاعب \n ✧'
end
Redis:del(RunThon..":Start_Rolet:"..msg.chat_id..msg.sender_id.user_id)  
return send(msg_chat_id,msg_id,Text)    
end
if text and text:match('^(@[%a%d_]+)$') and Redis:get(RunThon..":Number_Add:"..msg.chat_id..msg.sender_id.user_id) then    --// استقبال الاسماء
if Redis:sismember(RunThon..':List_Rolet:'..msg.chat_id,text) then
return send(msg_chat_id,msg_id,'⇜  اليوزر ['..text..'] موجود قبل' ,"md")
end
Redis:sadd(RunThon..':List_Rolet:'..msg.chat_id,text)
local CountAdd = Redis:get(RunThon..":Number_Add:"..msg.chat_id..msg.sender_id.user_id)
local CountAll = Redis:scard(RunThon..':List_Rolet:'..msg.chat_id)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
Redis:del(RunThon..":Number_Add:"..msg.chat_id..msg.sender_id.user_id) 
Redis:setex(RunThon..":Witting_StartGame:"..msg.chat_id..msg.sender_id.user_id,1400,true)  
...
if text == ''..(Redis:get(RunThon..'bot:bkbk6'..msg.chat_id) or 'لفاتع')..'' then
Redis:del(RunThon..'bot:bkbk6'..msg.chat_id)  
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)
local Num = Redis:get(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end 
if text == ''..(Redis:get(RunThon..'bot:bkbk7'..msg.chat_id) or 'لفاتع')..'' then
Redis:del(RunThon..'bot:bkbk7'..msg.chat_id)  
Redis:incrby(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)
local Num = Redis:get(RunThon.."TheRunThon:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
...
Redis:set(RunThon.."TheRunThon:Game:Example"..msg.chat_id,name)
